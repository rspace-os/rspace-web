...
pipeline {
    ...
    parameters {
        ...
        booleanParam(name: 'STORYBOOK', defaultValue: false, description: 'Feature branch only: build and bundle Storybook in the WAR; serving requires dev.storybook.preview.enabled=true')
