...
public class ClustermarketExceptionHandler {
  ...
  public ResponseEntity<String> handle(Exception exception) {
    ...
    } // Log 404 as error - 404 from Clustermarket represents data corruption or services offline,
    // as the initial call to get all details should only return existing bookings and equipment
