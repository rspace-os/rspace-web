...
public class ApiInventoryDOI extends LinkableApiObject {
  ...
  /** Path of the anonymous public identifier page, shared with ApiIdentifiersHelper. */
  public static final String PUBLIC_PAGE_PATH = "/public/inventory/";
   ...
   */
  @JsonIgnore private String publicLinkSuffix;
  ...
  public ApiInventoryDOI(DigitalObjectIdentifier identifier) {
    ...
    setPublicLinkSuffix(identifier.getPublicLink());
