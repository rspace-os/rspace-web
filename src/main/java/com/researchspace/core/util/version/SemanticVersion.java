...
/**
 * Class or encapsulating versions in format <code>major.minor.qualifier-suffix</code> or <code>
 * major.minor.qualifier.suffix</code>.
 *
 * <p>Objects should be immutable once constructed
 */
  ...
  public SemanticVersion(Integer major, Integer minor, Integer qualifier, String suffix) {
    ...
    if (minor == null && (qualifier != null || suffix != null)) {
      throw new IllegalArgumentException(
          "minor version cannot be null if qualifier or suffix set..");
    }
    if (minor == null && qualifier == null && suffix != null) {
