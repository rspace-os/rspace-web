...
public class ProgressMonitorImpl implements ProgressMonitor, Serializable {
  ...
  /**
   * @param totalWorkUnits must be &gt; 0
   * @param description
   * @throws IllegalArgumentException if <code>totalWorkUnits</code> &lt; 0
   */
  ...
  /** Default constructor for frameworks; clients should not use this constructor */
