...
/**
 * Basic abstraction over a progress monitor that can be used to pass progress information between
 * server and client.
 */
public interface ProgressMonitor {

  /**
   * Increment the the progress monitor by a given number of ticks. This will have no effect if any
   ...
   * </ul>
   *
   * @param workUnits A positive integer
   * @return this for method chaining
   * @throws IllegalArgumentException if <code>ticks</code> &lt; 0
   */
  ...
  /**
   * Request cancel of the operation. Implementations that don't support this can throw an {@link
