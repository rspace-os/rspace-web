...
public class DefaultTimeLimitedMemoryCache<T> implements TimeLimitedMemoryCache<T> {
  ...
  /**
   * @param cacheTimeMilliSeconds the cacheTimeMilliSeconds to set
   */
  ...
  public String toString() {
    ...
    return String.format(
        "Item last cached at %s for %d millis",
        (lastCacheTime != null) ? sdf.format(lastCacheTime) : "never cached", cacheTimeMillis);
  }
}
