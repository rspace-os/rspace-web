...
/**
 * Big File (>1GB) operation, add, find, update, delete, move, copy, compare, search associated path
 * operation CRD.
 */
public class FileOperator {
  ...
  /** Internally creates a new {@link FolderOperator} that determines the runtime FileStore root */
  public FileOperator() {
   ...
   *
   * @param targetPath the relative folder path within the filestore in which to put the file
   * @param source The file to add
   * @param fname The name of the file to be put in the filestore
   ...
   *
   * @param destination , a new output file
   * @param toCopy , a input original file
   * @param deleteToCopy , set true delete original as move operation
   * @throws IOException
   */
