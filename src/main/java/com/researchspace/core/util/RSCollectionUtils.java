...
public class RSCollectionUtils {
  /**
   * Takes 2 lists, which may contain overlapping elements, and returns a merged list. <br>
   * Assumptions
   *
   * <ul>
   *   <li>Elements in each input list are contiguous, and the elements in common will be contiguous
