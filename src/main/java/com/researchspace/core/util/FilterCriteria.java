...
/**
 * Base class of search criteria classes which uses reflection and annotation processing to identify
 * search fields.<br>
 * Subclasses should use regular JavaBean conventions (ie., to supply get/set methods for
 * properties), and identify search terms by the @UISearchTerm annotation.
 */
public class FilterCriteria implements Serializable {
      ...
      if (sterm != null) {
        ...
        if (field.getType().isArray()) {
          ...
          try {
            ...
            Method getter =
                new PropertyDescriptor(field.getName(), this.getClass()).getReadMethod();
  ...
  /**
   * Returns a string of this search class in URL query format. It does not include trailing or
   * leading '&' characters. Client code should decide if these are necessary, depending on if there
   * are other query items in the URL.
   *
   * @return A String in the form 'search_propname=propvalue&search_propname2='propvalue'
