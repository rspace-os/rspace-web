...
public class ResponseUtil {
   ...
   * @param response
   */
  public void setCacheTimeInBrowser(
      int timeInSecondsToCache, Date lastModified, HttpServletResponse response) {
  ...
  /**
   * Sets the filename of the downloaded file to the desired name, which can be different to the
   * file's real name. E.g., it can be a display name.
   *
   * @param response
   * @param name
   */
