...
public class JacksonUtil {
  ...
  /**
   * Converts object to Json string using Jackson's object mapper without throwing a checked
   * exception
   *
   * @param object
   * @return A Json string or empty string of a {@link JsonProcessingException} was thrown
   *     internally.
   */
  ...
  /**
   * Converts object to Json string using Jackson's object mapper without throwing a checked
   * exception. Skips empty (null or "absent") fields.
   *
   * @param object
   * @return A Json string or empty string of a {@link JsonProcessingException} was thrown
   *     internally.
  ...
  public static <T> T fromJson(
      String json, Class<T> clazz, UnaryOperator<ObjectMapper> configurer) {
    try {
   ...
   * @return An optional, will be empty if Jackson couldn't parse.
   */
  public static <T> Optional<T> fromJsonOpt(
      String json, Class<T> clazz, UnaryOperator<ObjectMapper> configurer) {
