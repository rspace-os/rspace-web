...
/** Utility class for running command line external processes; delegates to apache.commons.exec. */
public class CommandLineRunner {

  static Logger logger = LoggerFactory.getLogger(CommandLineRunner.class);

  /**
   * Most basic command line runner that assumes that command line has no characters requiring
   * escaping and will return a string. <br>
