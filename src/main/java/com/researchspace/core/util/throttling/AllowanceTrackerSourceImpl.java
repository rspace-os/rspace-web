 ...
 *
 * <p>This implementation stores allowances in memory.
 */
public class AllowanceTrackerSourceImpl implements AllowanceTrackerSource {
  ...
  public AllowanceTrackerSourceImpl(
      TimeSource timeSource, ThrottleDefinitionSet throttleDefinitions) {
  ...
  private AllowanceTracker initTracker(String userId) {
    ...
    for (Map.Entry<ThrottleInterval, ThrottleLimitDefinition> pair :
        throttleDefinitions.getThrottleLimits().entrySet()) {
