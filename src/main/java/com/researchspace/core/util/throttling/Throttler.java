...
public interface Throttler {
   ...
   *
   * Default implementation, if this method is not implemented in subclasses, returns <code>true
   * </code>.
   *
   * @param identifier An identifier for the client making the request
   * @param requestedResourceUnits
   * @return <code>true</code> if request should proceed, i.e. is in within usage limits
   * @throws TooManyRequestsException if cannot proceed.
   */
  ...
  /**
   * Determines whether a request should be allowed to proceed, using default of 1 requested
   * resource units. <br>
