...
/**
 * Special characters that are not acceptable to UNIX/HTML should be replace by under score Feel
 * free to add new escape character in the escape string @Sunny
 */
public class EscapeReplacement {
   ...
   * replaced with corresponding character entities : < -->&lt; >-->&gt; &-->&amp; " -> &quot; '-->
   * &#039;
   */
