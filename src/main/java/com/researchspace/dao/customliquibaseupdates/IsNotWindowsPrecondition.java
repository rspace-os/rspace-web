...
/** A custom liquibase precondition filter that passes if the OS is <strong>not</strong> windows */
public class IsNotWindowsPrecondition implements CustomPrecondition {
