...
public class EcatImageWorkingToFileProperties_RSPAC2199 extends BlobMigrationBase {

  @Override
  public String getConfirmationMessage() {
    return "Ecat working images transferred";
  }
  ...
  protected void doExecute(Database database) {
    ...
    String updateSQL =
        "update EcatImage set workingImageFP_id = :fpid where id = :id and"
            + " imageFileRezisedEditor_id = :blobId";
    String progressLogMsg = "Transferring EcatImage Working images";
