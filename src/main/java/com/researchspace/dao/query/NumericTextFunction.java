 ...
 *
 * <p>The precision and scale match the bounds enforced by {@code RuntimeFieldValueType} and {@code
 * ExtraNumberField}: MariaDB supports at most 65 total digits and 30 fractional digits. Making both
 * explicit also avoids the default {@code decimal(10,0)}, which would silently truncate {@code
 * -80.5} to {@code -80}.
 */
public final class NumericTextFunction implements JpqlFunction {
  ...
  public void render(FunctionRenderContext context) {
    ...
    context.addArgument(0);
    context.addChunk(" as decimal(65,30)) else null end)");
  }
}
