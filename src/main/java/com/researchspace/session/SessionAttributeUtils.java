...
/** Class to hold names & static methods for session attributes in one place to avoid confusion. */
public class SessionAttributeUtils {
  ...
  /** Name for session attribute as to whether user is operating as another user */
  ...
  /**
   * Whether initialisation that is supposed to happen after the first time user logs in to their
  ...
  /**
   * Get timezone from the string value of the TIMEZONE session attribute. Will be UTC if this is
