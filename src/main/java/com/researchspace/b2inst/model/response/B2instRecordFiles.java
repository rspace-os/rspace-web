 ...
 *
 * <p>Unlike the draft file-listing returned by the upload endpoints, the record-level container
 * keys its {@link #entries} by file name and reports aggregate counts. On a freshly created draft
 * it is enabled but empty.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
