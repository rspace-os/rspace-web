...
public enum HierarchicalPermission {
  ...
  /**
   * Converts true / false permissions to Permission Enum values. True is converted to ALLOWED.
   * False is converted to DENIED. Permission Enum values are not changed.
   *
   * @param value
