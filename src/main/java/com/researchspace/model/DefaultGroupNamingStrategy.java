...
public class DefaultGroupNamingStrategy implements IGroupNamingStrategy {
  ...
  public String getSharedGroupName(Group grp) {
    String sharedGrpname =
        (grp.getDisplayName() != null ? grp.getDisplayName() : grp.getUniqueName());
  ...
  /** Gets a reproducible name for the individual shared folder based on the users' names. */
  @Override
