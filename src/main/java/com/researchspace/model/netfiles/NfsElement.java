...
/**
 * This does not correspond to a DB entity - we do not store individual links to external filesystem
 * files, so ID is an invention based on hashcode of filestore ID and the path, which should be
