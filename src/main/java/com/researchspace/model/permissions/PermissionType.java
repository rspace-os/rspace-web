...
public enum PermissionType {
  ...
  /** Folder can be a target for another record ( i.e., something can be moved into it.) */
  FOLDER_RECEIVE,
  ...
  /**
   * // * Permissions to request external sharing of a record, to be used with {@link
   * PermissionDomain}.GROUP
   */
