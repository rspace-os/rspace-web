...
public interface PermissionFactory {
  ...
  /**
   * Default set of permissions for a group administrator. Creates a set of default permissions that
   * an Administrator will have in a group.
   *
   * @param group
   * @return
   */
  ...
  /**
   * Creates a set of default permissions that a PI will have in a collaboration group. At the
   * moment, it returns a set of permissions to be able to manage the collaboration group.
   *
   * @param group
   * @return
   */
  ...
  /**
   * Default set of permissions for a collaboration group administrator. It returns a set of
   * permissions to be able to manage the collaboration group and be able to send requests :
   *
   * <ul>
  ...
  /**
   * Default permissions for Project Group Owners. Permissions to manage the group and be able to
   * send requests for other users to join the project group.
   *
   ...
   */
  ConstraintBasedPermission createIdPermission(
  ...
  /**
   * Sets up ACL for a folder that will be a subfolder of individual shared folder i.e., the root of
   * user-pair sharing tree.
   *
   * @param sharer
   * @param sharee
   * @param grpFolder
   ...
   *
   * @param admin The user to grant the permission to
   * @param community the community the admin can edit
   * @return the newly created permissions
   */
  Set<ConstraintBasedPermission> createCommunityPermissionsForAdmin(
