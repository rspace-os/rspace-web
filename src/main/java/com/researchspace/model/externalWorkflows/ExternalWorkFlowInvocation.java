...
public class ExternalWorkFlowInvocation {
  ...
  @Setter @NotNull private String status;
  ...
  @Builder()
  public ExternalWorkFlowInvocation(
      @NonNull String extId,
      @NonNull Set<ExternalWorkFlowData> externalWorkFlowData,
      @NonNull String status,
      @NonNull ExternalWorkFlow externalWorkFlow) {
    this.extId = extId;
