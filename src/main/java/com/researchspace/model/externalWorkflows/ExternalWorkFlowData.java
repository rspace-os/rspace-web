...
public class ExternalWorkFlowData implements Serializable {
  ...
  @NotNull private long rspacedataid;
  ...
  /**
   * the id of the rspace field/document which was used to initiate data transfer for the external
   * workflow.
   */
  @NotNull private long rspacecontainerid;

  /**
   * the name of the rspace field/document which was used to initiate data transfer for the external
   * workflow.
   */
  @NotNull private String rspacecontainerName;
  ...
  @NotNull private String extName;

  /** The ID provided by the external service for this data */
  @NotNull private String extId;
  ...
  @NotNull private String extContainerID;

  /** Name for the 'container' storing the data on the external service */
  @NotNull private String extContainerName;
  ...
  public ExternalWorkFlowData(
      @NonNull ExternalService externalService,
      @NonNull long rspacedataid,
      @NonNull ExternalWorkFlowData.RspaceDataType rspaceDataType,
      @NonNull long rspacecontainerId,
      @NonNull String rspaceContainerName,
      @NonNull ExternalWorkFlowData.RspaceContainerType rspaceContainerType,
      @NonNull String extName,
      @NonNull String extId,
      @NonNull String extSecondaryId,
      @NonNull String extContainerID,
      @NonNull String extContainerName,
