...
public final class CollectionQueryLimits {
  ...
  /**
   * Runtime-field values one request may project.
   *
   * <p>Each one widens every row of the response and the batch load behind it, so this bounds
   * payload and database work the way the comparison limits bound query complexity.
   */
  public static final int MAX_RUNTIME_PROJECTIONS = 50;
