...
/**
 * Static lookup table for maintaining which archive schema versions are compatible with which
 * database versions.
 */
@Entity
...
public class ArchiveVersionToAppVersion implements Serializable {
  ...
  @Embedded
  @AttributeOverrides({
    @AttributeOverride(name = "major", column = @Column(name = "toMajor", nullable = false)),
  ...
  @Embedded()
  @AttributeOverrides({
    @AttributeOverride(name = "major", column = @Column(name = "fromMajor")),
  ...
  public String toString() {
    return "ArchiveVersionToAppVersion [fromInclusive="
        + fromInclusive
        + ", toExclusive="
        + toExclusive
        + ", schemaVersion="
