...
/**
 * Audit event for an object being restored from a deleted state, or previous revision to a current
 * state
 */
public class RestoreEvent extends HistoricalEvent {
   ...
   *
   * @param restored The deleted object being restored
   */
   ...
   *
   * @param restored The deleted object being restored
   * @param revision the revision number being restored from.
   */
