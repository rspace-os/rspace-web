...
public class GenericEvent extends HistoricalEvent {
   ...
   * @param auditedObject the domain object being audited
   ...
   * @param auditedObject the domain object being audited
   * @param action The audit action
   * @param description An optional, brief, plain-text description of the event, can be null.
   */
  public GenericEvent(
      Person subject, Object auditedObject, AuditAction action, String description) {
