...
/** Map ( possibly nested) of key/value pairs storing data particular to an audited object. */
@Getter
@EqualsAndHashCode
public class AuditData {
  ...
  /**
   * @param fieldValue should be a primitive type, or serializable to JSON, or an AuditData object
   */
  @JsonAnySetter
