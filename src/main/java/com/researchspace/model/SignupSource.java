...
public enum SignupSource {
  /**
   * USer either signed up or was created by sysadmin, or batchuploaded. I.e. user identity was
   * created in RSpace
   */
  MANUAL,
  ...
  /** User account created programmatically - e.g. admin account, test account etc */
  INTERNAL,
