...
public class EcatComment implements Serializable, IFieldLinkableElement {
  ...
  @FullTextField private String comDesc;

  @FullTextField private String lastUpdater;

  @FullTextField private String author;
   ...
   *
   * @param fieldId id of the field this comment belongs too
   * @param record record this comment belongs too
  ...
  /**
   * Creates a new EcatComment with copied data fields. Database id, and parent relations are null.
   * Comment items are not copied
   *
   * @return
   */
  ...
  /**
   * Creates a new EcatComment with copied data fields. Database id, and parent relations are null.
   * Comment items <em>are</em> copied.
   *
   * @return
   */
  @Transient
