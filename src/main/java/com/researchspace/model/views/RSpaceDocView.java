...
public class RSpaceDocView implements IRSpaceDoc {
  ...
  @NonNull private Date modificationDateAsDate;
  ...
  public boolean isStructuredDocument() {
    return type.contains(RecordType.NORMAL.name()) || type.contains(RecordType.TEMPLATE.name());
  }
