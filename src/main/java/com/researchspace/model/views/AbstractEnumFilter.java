...
/**
 * Abstract generic class for specifying enum types to include or exclude, for example to
...
public abstract class AbstractEnumFilter<E extends Enum<E>> {
   ...
   *
   * @param types A non-null {@link EnumSet}
   * @param include <code>true</code> to <em>include</em> <code>types</code>, false to
   *     <em>exclude</em> <code>types</code>.
   * @throws IllegalArgumentException if <code>types</code> is <code>null</code>.
   */
