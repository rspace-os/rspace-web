...
/**
 * Generic class to store results , failures and exceptions when a service is working on a stream of
 * results.
 *
...
public class ServiceOperationResultCollection<T, U> {
   ...
   */
  public ServiceOperationResultCollection<T, U> merge(
      ServiceOperationResultCollection<T, U> other) {
