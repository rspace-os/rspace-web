...
public class FormSearchCriteria extends FilterCriteria {
  ...
  /**
   * Only include forms created by the user. DEfault is <code>false</code> since this class is used
   * in many different sorts of Form search, not just in form listing. RSPAC-1749
   */
  @UISearchTerm private boolean userFormsOnly = false;

  /**
   * @return <code>true</code> if we only want to search published forms. Defaults to <code>true
   *     </code>.
   */
  private boolean publishedOnly = true;

  @UISearchTerm private String searchTerm;

  @UISearchTerm private PermissionType requestedAction = PermissionType.READ;
