...
@Table(
    indexes = {
      @Index(columnList = "sourceType", name = "INDEX_THUMBNAIL_SOURCE_TYPE"),
...
public class Thumbnail implements Serializable, IFieldLinkableElement {
   ...
   *
   * @param url
   * @return a transient thumbnail or <code>null</code> if source/parent ids could not be parsed.
   */
  ...
  /**
   * Convenience boolean test as to whether this is a thumbnail of a ChemElement or not
   *
   * @return
   */
  @Transient
  ...
  /**
   * Convenience boolean test as to whether this is a thumbnail of an EcatImage or not
   *
   * @return
   */
  @Transient
