...
/**
 * Embeddable persistable class for entity objects needing a Unix-type access control information.
 * Equality is based on the values of the enums comprising the access control.
 *
...
public class AccessControl implements Serializable {
  ...
  public String toString() {
    return "AccessControl [ownerPermissionType="
        + ownerPermissionType
        + ", groupPermissionType="
        + groupPermissionType
        + ", worldPermissionType="
  ...
  private static List<PermissionType> types =
      Arrays.asList(
          new PermissionType[] {PermissionType.NONE, PermissionType.READ, PermissionType.WRITE});
