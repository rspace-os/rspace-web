...
public enum TokenBasedVerificationType {
  ...
  /** A token-based approach to verify a password change request default timeout = 1 hour */
  ...
  /**
   * A token based validation of new email address. After following the link users needs to log in,
   * so there is little risk. Default timeout same as VERIFIED_SIGNUP (3 weeks)
   */
