...
public class Organisation implements Serializable {
  ...
  /**
   * Maximum length of an indexable varchar field that can be encoded in UTF-8, in case DB uses 4
   * bytes per character; MySQL 5.6 uses 767 max key length = 191 max chars * 4 bytes/char.<br>
   * See RSPAC-932
   */
