...
public class SystemPropertyValue implements Serializable {
  ...
  public String toString() {
    return "SystemPropertyValue [property="
        + property.getName()
        + ", value="
        + value
        + ", id="
  ...
  public int hashCode() {
    ...
    if (community != null) result = prime * result + community.hashCode();
    return result;
  }
   ...
   *
   * @param value
   * @throws IllegalArgumentException if value is not compatible with the underlying {@link
   *     SettingsType} of this property
   */
