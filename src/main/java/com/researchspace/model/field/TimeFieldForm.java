...
public class TimeFieldForm extends FieldForm {
  ...
  public String toString() {
    return "TimeFieldTemplate [timeFormat="
        + timeFormat
        + ", defaultTime="
        + defaultTime
        + ", minTime="
  ...
  public String getSummary() {
    String minValue =
        StringUtils.isEmpty(getMinTimeAsString()) ? "Unspecified" : getMinTimeAsString();
    String maxValue =
        StringUtils.isEmpty(getmaxTimeAsString()) ? "Unspecified" : getmaxTimeAsString();
    String defValue =
        StringUtils.isEmpty(getDefaultTimeAsString()) ? "Unspecified" : getDefaultTimeAsString();
