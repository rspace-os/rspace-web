...
public enum FieldType {
  ...
  /**
   * Gets the field type for an input String or <code>null</code> if the argument could not be
   * matched to an enum. <br>
   * Accepted inputs are String representations of the enum constant - comparison is
   * case-insensitive
   *
   * @param fieldType
   * @return A {@link FieldType} or null if no FieldType could be matched to an enum.
   */
