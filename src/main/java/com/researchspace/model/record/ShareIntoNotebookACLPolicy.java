...
/**
 * Based on RSPAC-913. Propagates read/write ACL from parent notebook to all the entries. Doesn't
 * propagate group entries, so PI/Lab Admin doesn't get extra permissions.
 */
