...
/**
 * Encapsulates information regarding if an change has been made warranting an update to the user
 * version number, or if the revision history should be updated. <br>
