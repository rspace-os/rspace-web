 ...
 * Implementations shouldn't modify the record/folder hierarchy or modify the record container's
 * collections.
 */
public interface RecordContainerProcessor {
   ...
   * @return a boolean to indicate whether to continue processing a subtree(true) or to terminate
   *     (false).
   */
