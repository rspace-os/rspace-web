...
/**
 * Class with the most relevant information of a record. It's used for some ajax responses where it
 * doesn't need the whole information of a record. It's also used by FieldContents (from rspace-web)
 * as a reference to linked document.
 */
@Data
public class RecordInformation implements IFieldLinkableElement {
  ...
  public boolean equals(Object obj) {
    ...
    return new EqualsBuilder()
        ...
        .append(extension, other.extension)
        .append(heightResized, other.heightResized)
        .append(iconId, other.iconId)
        .append(id, other.id)
        .append(isOnRoot, other.isOnRoot)
        .append(modificationDate, other.modificationDate)
        .append(name, other.name)
        .append(oid, other.oid)
        .append(originalFileName, other.originalFileName)
        .append(ownerFullName, other.ownerFullName)
        .append(ownerId, other.ownerId)
        .append(ownerUsername, other.ownerUsername)
        .append(parentId, other.parentId)
        .append(size, other.size)
        .append(templateId, other.templateId)
        .append(thumbnailId, other.thumbnailId)
        .append(type, other.type)
        .append(version, other.version)
        .append(rotation, other.rotation)
        .append(widthResized, other.widthResized)
        .append(originalImageOid, other.originalImageOid)
        .isEquals();
  }

  @Override
  public String toString() {
    return "RecordInformation [id="
        + id
        + ", name="
        + name
        + ", originalFileName="
