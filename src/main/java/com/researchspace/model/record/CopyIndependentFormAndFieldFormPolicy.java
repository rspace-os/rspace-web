...
/**
 * Generates an independent copy of the Form and its field forms, with new creation and modification
 * dates.<br>
 * No modification is made to the original.<br>
 * This copy will have a new stable Id, and the owner of the copy will be the user performing the
 * copy, <b>NOT</b> the owner of the original.
 */
