...
public class Snippet extends Record {
  ...
  /**
   * Copies this record and its content. This method does not copy associated data such as image
   * annotations, comments etc. To properly copy these, call RecordManagerImpl#copy
   */
  @Override
  public Snippet copy() {
