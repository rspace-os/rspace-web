...
/**
 * Strategy for deciding whether a parent-child relationship between two record types is allowed.
 */
public interface ChildAddPolicy {
  ...
  ChildAddPolicy DEFAULT =
      (Folder parentToBe, BaseRecord childToBe) -> {
