...
public enum DeltaType {
  ...
  /**
   * This is a special delta type that does *not* increment doc user version, and does not result in
   * a new entry in the revision history either.
   *
   * <p>See PermanentEntityFilter in rspace-web.
   */
