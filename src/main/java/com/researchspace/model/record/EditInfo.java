...
/**
 * Component class to be included in records /forms and future classes that need to record
 * user-editing.
 */
@Embeddable
public class EditInfo implements Serializable {
  ...
  /**
   * Once this method has been called once for this object, future invocations will have no effect.
   *
   * @param creationDate
   */
  ...
  public boolean equals(Object obj) {
    ...
    if (creationDateMillis == null) {
      if (other.creationDateMillis != null) return false;
    } else if (!creationDateMillis.equals(other.creationDateMillis)) return false;
    if (getName() == null) {
