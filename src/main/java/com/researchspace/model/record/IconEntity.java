...
public class IconEntity implements Serializable {
  ...
  /**
   * Static factory class to create a transient IconEntity for an image. <br>
   * This method scales image if possible to default thumbnail size of 64
   *
   ...
   * @throws IOException
   */
  public static IconEntity createIconEntityFromImage(
      Long parentId, BufferedImage img, String optionalImageType) throws IOException {
