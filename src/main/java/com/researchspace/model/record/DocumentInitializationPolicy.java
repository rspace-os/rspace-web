...
public abstract class DocumentInitializationPolicy {
  ...
  /**
   * Decorates other DocumentInitializationPolicy policies. <br>
   * Nested policies are run before outer policies.
   *
   * @param decoratedPolicy should not be <code>null</code>. Use the default constructor if you
   *     don't want to decorate another {@link DocumentInitializationPolicy}
   */
  ...
  /**
   * Perform initialization of whatever lazy-loaded properties need to be initialised, to be
   * implemented by subclasses.
   *
   * @param baseRecord A {@link Record}
   */
