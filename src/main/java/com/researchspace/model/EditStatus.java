...
public enum EditStatus {
  ...
  /**
   * An intrinsic property of the document makes it never editable, regardless of permissions (for
   * example the document is signed, or is an old revision).
   */
  ...
  /**
   * Boolean test as to whether an {@link EditStatus} represents an editable document or not.
   *
   * @return
   */
