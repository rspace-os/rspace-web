...
public class Notification extends Communication implements Serializable {
  ...
  /**
   * Sets max message, max length = 2000 characters; longer messages will be truncated.
   *
  ...
  /**
   * Whether the document should be linked to in messages derived from this notification. For
   * example if notification is about a document that is deleted or unshared then providing a link
   * that won't resolve is to be avoided.
   *
