...
public enum CommunicationStatus {
  ...
  /**
   * Indicates a user has responded to a SimpleMessage; this should only be used for MessageTypes of
   * SimpleMessage.
   */
  REPLIED;

  /**
   * Boolean test for whether a {@link CommunicationStatus} object is in a terminated state.
   *
   * @return
   */
