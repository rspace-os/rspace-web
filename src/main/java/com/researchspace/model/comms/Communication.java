...
public abstract class Communication implements Serializable, UniquelyIdentifiable {
  ...
  /**
   * The user whose actions led to the communication being created, either directly, or indirectly (
