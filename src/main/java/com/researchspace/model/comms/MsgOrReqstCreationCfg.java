...
public class MsgOrReqstCreationCfg implements Serializable {
  ...
  /**
   * Will initialise this command with a list of messageTypes that this user has permission to
   * create, chosen from ALL message types
   *
   * @param user authenticated subject
   */
  ...
  /**
   * Will initialise this command with a list of messageTypes that this user has permission to
   * create, chosen from the supplied list of message types
   *
   * @param user authenticated subject
   * @param permissionUtils
   */
  public MsgOrReqstCreationCfg(
      User user, IPermissionUtils permissionUtils, MessageType... messageTypes) {
   ...
   * @throws if the String cannot be parsed into a {@link TargetFinderPolicy}.
   */
