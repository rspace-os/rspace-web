...
/**
 * Extension of MessageOrRequest to store information about requests concerning create group. This
 * is for RSPAC-245 uc2 where user is nominating another user to be a PI of a group.
 */
@Entity
public class CreateGroupMessageOrRequest extends MessageOrRequest implements Serializable {
  ...
  public String toString() {
    return "CreateGroupMessageOrRequest [creator="
        + creator
        + ", target="
        + target
        + ", groupName="
