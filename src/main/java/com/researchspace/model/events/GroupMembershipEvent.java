...
/**
 * Event log of Group membership - related actions. This is a table rather than in the audit log as
 * this information will be queried more frequently (in group and profile pages), will be quite
...
public class GroupMembershipEvent implements Serializable {
  ...
  GroupMembershipEvent(
      Long id, User user, Group group, GroupEventType groupEventType, Date timestamp) {
    super();
    this.id = id;
    this.user = user;
  ...
  public GroupMembershipEvent(
      @NotNull User user, @NotNull Group group, @NotNull GroupEventType groupEventType) {
  ...
  @TableGenerator(
      name = "group_membership_event_gen",
