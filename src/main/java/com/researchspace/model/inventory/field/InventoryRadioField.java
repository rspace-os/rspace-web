...
public class InventoryRadioField extends InventoryEntityField {
  ...
  /**
   * Returns a <code>List</code> of possible radio options, or an empty list if no radio options
   * have yet been set.
   *
   ...
   *
   * <p>Radio field allows only one option being selected, so method accepts only a list with size 0
   * or 1.
   *
