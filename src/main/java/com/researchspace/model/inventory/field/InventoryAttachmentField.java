...
public class InventoryAttachmentField extends InventoryEntityField {
  ...
  /**
   * All files ever connected to that Inventory Entity field, deleted or not. There should be at
   * most one non-deleted file there.
   */
  ...
  public void validateBeforeSave() {
    ...
    if (attachmentCount > 1) {
      throw new ConstraintViolationException(
          "Inventory attachment field can link only one attachment", null);
    }
  }
}
