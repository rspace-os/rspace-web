...
@Audited
public class DigitalObjectIdentifier extends InventoryRecordConnectedEntity
  ...
  private IdentifierType type =
      IdentifierType.IGSN_DATACITE; // default type, kept for backwards compatibility
  ...
  /**
   * Values stored as a JSON map in {@code otherDataJsonString}, keyed by the enum name, so adding a
   * property needs no schema change.
   *
  ...
  public enum IdentifierOtherProperty {
    ...
    CREATOR_TYPE,
    CREATOR_AFFILIATION,
    CREATOR_AFFILIATION_IDENTIFIER,
    PUBLISHER,
    PUBLICATION_YEAR,
    RESOURCE_TYPE,
  ...
  @TableGenerator(
      name = "digital_object_identifier_gen",
