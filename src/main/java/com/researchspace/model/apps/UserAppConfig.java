...
public class UserAppConfig implements Serializable, PermissionsAdaptable {
   ...
   * @throws IllegalArgumentException if <code>toAdd</code> is empty.
   * @throws IllegalArgumentException if app does not allow multiple configs and there is already an
   *     existing config for this User/App combination.
   */
