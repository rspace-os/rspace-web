...
public class RecordGroupSharing implements Serializable {
  ...
  /**
   * Returns the folder (notebook) that the record was "shared into", or null if the record was
   * shared normally (into group/individual shared folder).
   */
  @ManyToOne
