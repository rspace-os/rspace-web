...
public class Role implements Serializable, Permissable {
  ...
  private static final String[] VALID_ROLES =
      new String[] {
        ...
        Constants.ANONYMOUS_ROLE,
        Constants.GROUP_OWNER_ROLE
      };
  ...
  /**
   * @param roleName A valid role name as determined by isRoleStringIdentifiable()
   * @throws IllegalArgumentException if <code>roleName</code> is invalid
   */
