...
/**
 * Similar to FieldAttachment, this is a join table for Record/EcatMedia associations. This needs to
 * be an entity, rather than defined as ManyToMAny since otherwise the revision history mechanism
 * fails.
 */
@Entity
@Audited
