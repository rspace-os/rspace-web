...
public class RSUnits {
  ...
  public static final Unit<Concentration> MOLAR =
      Units.MOLE.divide(Units.LITRE).asType(Concentration.class);
  public static final Unit<Concentration> MILLI_MOLAR =
      MetricPrefix.MILLI(Units.MOLE).divide(Units.LITRE).asType(Concentration.class);
  public static final Unit<Concentration> MICRO_MOLAR =
      MICRO(Units.MOLE).divide(Units.LITRE).asType(Concentration.class);
  public static final Unit<Concentration> NANO_MOLAR =
      MetricPrefix.NANO(Units.MOLE).divide(Units.LITRE).asType(Concentration.class);
  ...
  public static final Unit<Concentration> MICROGM_PER_MICROL =
      MICROGRAM.divide(MICROLITRE).asType(Concentration.class);
  ...
  public static final Unit<CatalyticActivity> ENZYME_UNIT =
      MICRO(Units.MOLE).divide(Units.MINUTE).asType(CatalyticActivity.class);

  // derived area units
  public static final Unit<Area> CM_SQUARED =
      CENTI(Units.METRE).multiply(CENTI(Units.METRE)).asType(Area.class);
  public static final Unit<Area> MM_SQUARED =
      MILLI(Units.METRE).multiply(MILLI(Units.METRE)).asType(Area.class);
  public static final Unit<Area> KM_SQUARED =
      KILO(Units.METRE).multiply(KILO(Units.METRE)).asType(Area.class);

  // derived volume units
  public static final Unit<Volume> CUBIC_MILLIMETRE =
      MILLI(Units.METRE)
  ...
  public static final Unit<Volume> CUBIC_CENTIMETRE =
      CENTI(Units.METRE)
          .multiply(CENTI(Units.METRE))
          .multiply(CENTI(Units.METRE))
          .asType(Volume.class);
  public static final Unit<Volume> CUBIC_DECIMETRE =
      DECI(Units.METRE)
          .multiply(DECI(Units.METRE))
          .multiply(DECI(Units.METRE))
          .asType(Volume.class);
  ...
  public static final List<Unit<Radioactivity>> BEQS =
      Arrays.asList(new Unit[] {MBeq, kBeq, Units.BECQUEREL, mBeq});

  @SuppressWarnings("unchecked")
  public static final List<Unit<Radioactivity>> CURIES =
      Arrays.asList(new Unit[] {millicurie, curie});

  @SuppressWarnings("unchecked")
  public static final List<Unit<Mass>> MASS_UNITS =
      Arrays.asList(
          new Unit[] {
            GRAM, MILLI(GRAM), MICRO(GRAM), NANO(GRAM), PICO(GRAM), MetricPrefix.FEMTO(GRAM)
          });

  @SuppressWarnings("unchecked")
  public static final List<Unit<Volume>> VOLUME_UNITS =
      Arrays.asList(new Unit[] {MICROLITRE, MILLILITRE, Units.LITRE});

  @SuppressWarnings("unchecked")
  public static final List<Unit<Area>> AREA_UNITS = Arrays.asList(new Unit[] {Units.SQUARE_METRE});

  @SuppressWarnings("unchecked")
  public static final List<Unit<Concentration>> CONCENTRATION_UNITS =
      Arrays.asList(new Unit[] {MILLI_MOLAR, MOLAR, MICRO_MOLAR, NANO_MOLAR});

  @SuppressWarnings("unchecked")
  public static final List<Unit<Temperature>> TEMPERATURE_UNITS =
      Arrays.asList(new Unit[] {Units.KELVIN, Units.CELSIUS});

  @SuppressWarnings("unchecked")
  public static final List<Unit<CatalyticActivity>> CATALYSIS_UNITS =
      Arrays.asList(new Unit[] {NANOKATAL, MICROKATAL, ENZYME_UNIT});

  @SuppressWarnings("unchecked")
  public static final List<Unit<Time>> TIME_UNITS =
      Arrays.asList(new Unit[] {Units.SECOND, Units.MINUTE, Units.HOUR, Units.DAY, Units.YEAR});
}
