...
public class Version implements Comparable<Version>, Serializable {
   ...
   * Main constructor.
   *
   * @param version A non-null {@link Long}
   * @throws if argument is <code>null</code>.
   */
  ...
  /**
   * Returns a new {@link Version} object with the incremented version. Does not change the state of
   * this object.
   *
   ...
   *
   * @param other A non-<code>null</code> Version
