...
public interface WorkspaceService {
   ...
   */
  List<ServiceOperationResult<? extends BaseRecord>> moveRecords(List<Long> toMove, String targetFolderId, Long workspaceParentId, User user);
   ...
   */
  int moveRecordsCountSuccess(List<Long> toMove, String targetFolderId, Long workspaceParentId, User user);
}
