...
public enum SystemPropertyName {
  ...
  IGSN_DATACITE_ENABLED("datacite.enabled"),
  IGSN_DATACITE_SERVER_URL("datacite.server.url"),
  IGSN_DATACITE_USERNAME("datacite.username"),
  IGSN_DATACITE_PASSWORD("datacite.password"),
  IGSN_DATACITE_REPOSITORY_PREFIX("datacite.repositoryPrefix"),
  PDINST_DATACITE_PROVIDER("pdinst.datacite.provider"),
  PDINST_DATACITE_ENABLED("pdinst.datacite.enabled"),
  PDINST_DATACITE_SERVER_URL("pdinst.datacite.server.url"),
  PDINST_DATACITE_USERNAME("pdinst.datacite.username"),
  PDINST_DATACITE_PASSWORD("pdinst.datacite.password"),
  PDINST_DATACITE_REPOSITORY_PREFIX("pdinst.datacite.repositoryPrefix"),
