...
public enum SystemPropertyName {
  ...
  PDINST_PROVIDER("pdinst.datacite.provider"),
  PDINST_ENABLED("pdinst.datacite.enabled"),
  PDINST_SERVER_URL("pdinst.datacite.server.url"),
  PDINST_USERNAME("pdinst.datacite.username"),
  PDINST_PASSWORD("pdinst.datacite.password"),
  PDINST_REPOSITORY_PREFIX("pdinst.datacite.repositoryPrefix"),
