...
public enum SystemPropertyName {
  ...
  PDINST_PROVIDER("pdinst.provider"),
  PDINST_ENABLED("pdinst.enabled"),
  PDINST_SERVER_URL("pdinst.server.url"),
  PDINST_USERNAME("pdinst.username"),
  PDINST_PASSWORD("pdinst.password"),
  PDINST_REPOSITORY_PREFIX("pdinst.repositoryPrefix"),
