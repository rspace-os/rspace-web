...
public class AuditTrailSearchElement {
  ...
  public String toString() {
    return "AuditTrailSearchElement [usernames="
        + usernames
        + ", dateRange="
        + dateRange
        + ", domains="
  ...
  public AuditTrailSearchElement(IAuditTrailSearchConfig inputSearchConfig) {
    ...
    if (inputSearchConfig.getDateTo() != null) {
      Date toDate =
          new DateTime(inputSearchConfig.getDateTo())
              .plusHours(HOURS)
              .plusMinutes(MINUTES)
              .plusSeconds(SECONDS)
              .toDate();
    ...
    DateRange dateRange =
        new DateRange(inputSearchConfig.getDateFrom(), inputSearchConfig.getDateTo());
