...
public interface BookingConfigurationDao extends CollectionDao<BookingConfiguration, Long> {
  ...
  /**
   * Locks an Active configuration and refreshes scheduling/access facts for its target identity.
   */
  ...
  /** Locks an Active configuration and refreshes scheduling/access facts by its identifier. */
