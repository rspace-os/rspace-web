 ...
 * VelocityEngineFactory for any resource loader path that cannot be resolved to a {@code
 * java.io.File}.
 *
 * <p>Note that this loader does not allow for modification detection: Use Velocity's default
 * FileResourceLoader for {@code java.io.File} resources.
 *
 * <p>Expects "spring.resource.loader" and "spring.resource.loader.path" application attributes in
 * the Velocity runtime: the former of type {@code org.springframework.core.io.ResourceLoader}, the
 * latter a String.
 *
...
public class SpringResourceLoader extends ResourceLoader {
  ...
  public void init(ExtendedProperties configuration) {
    ...
    String resourceLoaderPath =
        (String) this.rsvc.getApplicationAttribute(SPRING_RESOURCE_LOADER_PATH);
    ...
    if (logger.isInfoEnabled()) {
      logger.info(
          "SpringResourceLoader for Velocity: using resource loader ["
              + this.resourceLoader
