...
const getMockProperty = (obj: unknown, key: string, defaultValue: number): number => {
  ...
  Object.defineProperty(HTMLImageElement.prototype, "src", {
    ...
    get() {
      return originalDescriptor?.get
        ? (originalDescriptor.get as (this: HTMLImageElement) => string).call(this as HTMLImageElement)
        : "";
    },
    set(_value: string) {
      // Set default dimensions when src is set
      setMockProperty(this, "__mockWidth", getMockProperty(this, "__mockWidth", 600));
      setMockProperty(this, "__mockHeight", getMockProperty(this, "__mockHeight", 600));
      setMockProperty(this, "__mockNaturalWidth", getMockProperty(this, "__mockNaturalWidth", 600));
      setMockProperty(this, "__mockNaturalHeight", getMockProperty(this, "__mockNaturalHeight", 600));

      queueMicrotask(() => {
        (this as { dispatchEvent?: (event: Event) => void }).dispatchEvent?.(new Event("load"));
      });
    },
  });
}
