 ...
 * also matches a row for "Other Data". `row()` instead scopes by the exact
 * name link inside the row, which is unambiguous regardless of other columns.
 */
export class WorkspaceTable {
  ...
  /** Clicks the record's name link — opens the document/notebook/folder. */
