...
export type DynamicUser = { username: string; password: string; fullName: string; apiKey: string };
...
export async function createDynamicUser(
  ...
  return { username, password: DYNAMIC_USER_PASSWORD, fullName: `E2E ${lastName}`, apiKey };
}
