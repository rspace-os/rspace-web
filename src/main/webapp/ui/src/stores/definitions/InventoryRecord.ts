 ...
 */
export type RecordType = "sample" | "container" | "subSample" | "sampleTemplate" | "instrument" | "instrumentTemplate";;

/**
 * The API encodes the type of the various Inventory records using an all-caps
 * snake-case encoding.
 */
export type ApiRecordType = "SAMPLE" | "CONTAINER" | "SUBSAMPLE" | "SAMPLE_TEMPLATE" | "INSTRUMENT" | "INSTRUMENT_TEMPLATE";
...
export function recordTypeToApiRecordType(rt: RecordType): ApiRecordType {
  ...
  if (rt === "instrumentTemplate") return "INSTRUMENT_TEMPLATE";
