        ...
        try {
            if (endpoint !== "search" && params.permalink) {
                ...
                const records = match<void, Array<Record<string, unknown> & { globalId: GlobalId }>>([
                    [
                        () => endpoint === "search",
                        data.records as Array<Record<string, unknown> & { globalId: GlobalId }>,
                    ],
                    [
                        () => endpoint === "samples",
                        data.samples as Array<Record<string, unknown> & { globalId: GlobalId }>,
                    ],
                    [
                        () => endpoint === "subSamples",
                        data.subSamples as Array<Record<string, unknown> & { globalId: GlobalId }>,
                    ],
                    [
                        () => endpoint === "containers",
                        data.containers as Array<Record<string, unknown> & { globalId: GlobalId }>,
                    ],
                    [
