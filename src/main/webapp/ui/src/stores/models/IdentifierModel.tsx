        ...
        try {
            if (
                await confirm(
                    ...
                    <>
                        The IGSN ID landing page, DataCite Commons, and the DataCite APIs will be updated with these
                        changes.
                        <br />
                        <br />
                        <strong>
                            Please ensure the IGSN ID metadata you provided does not contain any information you do not
                            want to make public before publishing, as this action cannot be fully undone.
                        </strong>
                        <br />
                        <br />
        ...
        try {
            if (
                await confirm(
                    ...
                    <>
                        The IGSN ID will be set to <strong>Registered</strong>. It will be removed from DataCite Commons
                        and the Public API, and the landing page will not display any metadata.
                        <br />
                        <br />
