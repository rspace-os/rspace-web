...
describe("method: importFile", () => {
    describe("When the server responds with some errors,", () => {
        beforeEach(() => {
            jest.spyOn(InvApiService, "post").mockImplementation((_resource: string, _params: object | FormData) => {
            ...
            jest.spyOn(ImportModel.prototype, "transformTemplateInfoForSubmission").mockImplementation(() => ({
                fields: [],
                name: "Template",
            }));
            jest.spyOn(ImportModel.prototype, "makeMappingsObject").mockImplementation(() => ({}));
        });
        ...
        test("they should have the correct index.", async () => {
            ...
            jest.spyOn(uploadModel.state, "transitionTo").mockImplementation(() => {});
