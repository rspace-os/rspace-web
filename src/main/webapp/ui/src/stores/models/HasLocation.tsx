    ...
    return class extends Base implements HasLocation {
        ...
        constructor(...args: any[]) {
            ...
            this.lastMoveDate = Parsers.getValueWithKey("lastMoveDate")(params)
                ...
                .orElse(null);
            const lastNonWorkbenchParentParams = Parsers.getValueWithKey("lastNonWorkbenchParent")(
                params,
            ).elseThrow() as
        ...
        adjustableTableOptions(): AdjustableTableRowOptions<string> {
            ...
            const gridCoordinatesLabel = lift2<GridLayout, Location, string>(
                ({ rowsLabelType, rowsNumber, columnsLabelType, columnsNumber }, parentLocation) => {
                    const rowLabel = layoutToLabel(
                        rowsLabelType,
                        rowsNumber !== "" ? rowsNumber : 1,
                        parentLocation.coordY,
                    );
                    ...
                    const insertComma =
                        NUMERICAL_AXES.includes(rowsLabelType) && NUMERICAL_AXES.includes(columnsLabelType);
