...
function RoRIntegration(): React.ReactNode {
    ...
    const updateRor = async () => {
        const updatedRoR = candidateRor ? candidateRor.replaceAll("/", RSPACE_ROR_FORWARD_SLASH_DELIM) : "";
        try {
    ...
    const fetchDetails = async (rorID: string) => {
        if (rorID) {
            const searchTerm = rorID ? rorID.replaceAll("/", RSPACE_ROR_FORWARD_SLASH_DELIM) : "";
            try {
            ...
            <ThemeProvider theme={materialTheme}>
                <div>
                    ...
                    <RorHelpText>
                        ...
                        with your RSpace instance, you ensure the research outputs produced in RSpace are connected with
                        your research organisation. All research outputs with a DOI will automatically include the ROR
                ...
                {!rorDetails && (
                    <RorHelpText>
                        ...
                        to ensure you are adding the correct ROR ID. If your institution does not have a ROR ID, you can
                        submit a{" "}
                        <a
                            target="_blank"
                            rel="noreferrer"
                ...
                {candidateRor && rorDoesNotMatchCandidateRor() && !errorMessage && (
                    <RorHelpText>
                        ROR ID found. Click <b>Link</b> to associate with this RSpace Instance.
                    </RorHelpText>
                )}
                {(rorMatchesCandidateRor() || (ror && !candidateRor)) && !errorMessage && (
                    <RorHelpText>
                        A ROR ID is linked to this RSpace Instance. Click on <b>UNLINK</b> to remove the association.
