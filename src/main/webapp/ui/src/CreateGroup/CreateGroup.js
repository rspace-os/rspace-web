...
class CreateGroup extends React.Component {
    ...
    getStepContent = (step) => {
        ...
        switch (step) {
            ...
            default:
                return <Step01 changeGroupName={this.changeGroupName} groupName={this.state.createGroup.groupName} />;
        }
    };
                ...
                <StyledEngineProvider injectFirst>
                    <ThemeProvider theme={materialTheme}>
                        ...
                        >
                            ...
                            <div style={this.styles.container}>{this.getStepContent(this.state.activeStep)}</div>
                            <Fade in={loading} unmountOnExit>
                                <LinearProgress color="primary" />
                            </Fade>
                            <span style={this.styles.errorText}>{this.state.errorMessage}</span>
                            <MobileStepper
                                steps={this.maxSteps}
                                position="static"
