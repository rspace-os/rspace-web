                        ...
                        <Grid container spacing={8}>
                            <Grid item xs={6}>
                                <Paper style={this.styles.paperContainer}>
                                    ...
                                    <div style={this.styles.selectSpacing} data-test-id="createGroupInviteMembers">
                                        {" "}
                                    ...
                                    <Grid style={this.styles.userDisplay}>{existingUsersDisplay}</Grid>
                                </Paper>
                            </Grid>
                            {newUsersDisplay && (
                                <Grid item xs={6}>
                                    <Paper style={this.styles.paperContainer}>
                                        ...
                                        <Grid style={this.styles.userDisplay}>{newUsersDisplay}</Grid>
                                    </Paper>
                                </Grid>
                            )}
                        </Grid>
