...
function GroupAutoshareManager({ groupId, groupDisplayName, isCloud, isLabGroup, isGroupAutoshareAllowed }) {
            ...
            <>
                {(!isLabGroup || isCloud || !isGroupAutoshareAllowed) && (
                    <Tooltip title={title} aria-label={title}>
                        <div>
                            <Button className={classes.autoshareManager} variant="outlined" size="small" disabled>
                ...
                {loaded && !autoshareStatus && (
                    <>
                        ...
                        >
                            ...
                            <DialogContent>
                                <DialogContentText>
                                    Enabling group-wide autosharing will enable autosharing for all non-PI members in
                                    the <b>{groupDisplayName}</b> group. Once enabled, new non-PI members will have
                ...
                {loaded && autoshareStatus && (
                    <>
                        ...
                        >
                            ...
                            <DialogContent>
                                <DialogContentText>
                                    Disabling group-wide autosharing will unshare all work shared by non-PI members in
                                    the <b>{groupDisplayName}</b> group. Once disabled, new non-PI members will no
                                    longer have autosharing automatically enabled on joining.
                                </DialogContentText>
                                <AdditionalInfo />
                            </DialogContent>
                            <DialogActions>
