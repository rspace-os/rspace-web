...
function GroupSeoManager({ groupId, groupDisplayName, isCloud, isLabGroup, isGroupSeoAllowed, canManagePublish }) {
                    ...
                    <Dialog open={enableDialogOpen} onClose={() => setEnableDialogOpen(false)} maxWidth="sm" fullWidth>
                        ...
                        <DialogContent>
                            <DialogContentText>
                                ...
                                <b>{groupDisplayName}</b> group to choose to have their documents indexed by SEO bots.
                                These documents will also be shown on the 'Published' page visible to the public.
                            </DialogContentText>
                        </DialogContent>
                        <DialogActions>
                    ...
                    >
                        ...
                        <DialogContent>
                            <DialogContentText>
                                ...
                                <b>{groupDisplayName}</b> group from allowing SEO bots to index their documents. Their
