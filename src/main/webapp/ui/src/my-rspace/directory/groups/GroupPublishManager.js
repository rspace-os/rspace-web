                    ...
                    <Dialog open={enableDialogOpen} onClose={() => setEnableDialogOpen(false)} maxWidth="sm" fullWidth>
                        ...
                        <DialogContent>
                            <DialogContentText>
                                ...
                                <b>{groupDisplayName}</b> group to publish and unpublish their own documents. PIs can
                                also unpublish these documents.
                            </DialogContentText>
                        </DialogContent>
                        <DialogActions>
                            <DialogButtons
            ...
            {loaded && publishAllowedStatus && (
                <>
                    ...
                    >
                        ...
                        <DialogContent>
                            <DialogContentText>
                                Disabling group-wide publication will prevent non PI members of the{" "}
                                <b>{groupDisplayName}</b> group publishing their own documents. They may still unpublish
