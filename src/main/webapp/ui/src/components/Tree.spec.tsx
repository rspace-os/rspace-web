    ...
    Then: async ({ page }, use) => {
        await use({
            "tree item {string} should be selected": async (itemName: string) => {
                await expect(page.getByRole("treeitem", { name: itemName })).toHaveAttribute("aria-selected", "true");
            },
            "tree item {string} should not be selected": async (itemName: string) => {
                await expect(page.getByRole("treeitem", { name: itemName })).toHaveAttribute("aria-selected", "false");
            },
            ...
            "no tree items should be selected": async () => {
                const selectedItems = page.locator('[role="treeitem"][aria-selected="true"]');
