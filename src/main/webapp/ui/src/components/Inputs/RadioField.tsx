                ...
                (
                    ...
                    <div
                        ...
                        className={clsx(
                            ...
                            typeof option.label !== "string" && classes.extraSpacingBetweenOptions,
                        )}
                    >
                        <FormControlLabel
                            classes={{
                            ...
                            control={
                                <Radio
                                    ...
                                    onClick={() =>
                                        updateSelected(
                                            allowRadioUnselection && value === option.value ? null : option.value,
                                        )
                                    }
                                />
                            }
...
export const OptionExplanation = withStyles<OptionExplanationArgs, { root: string }>(() => ({
    root: {
        fontSize: "0.825em",
    },
