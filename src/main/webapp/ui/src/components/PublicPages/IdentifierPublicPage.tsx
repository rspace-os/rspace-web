...
export const IdentifierDataGrid = ({ record, identifier }: IdentifierDataGridArgs): ReactNode => {
    ...
    return (
        <Grid container className={classes.pageWrapper}>
            ...
            <Grid aria-hidden={true} container className={clsx(classes.block, classes.header)} spacing={0}>
                <Grid item className={classes.logo}>
                    <img src={INSTITUTION_LOGO_ADDRESS} alt="Institution Logo" title="Institution Logo" />
                </Grid>
                <Grid>
            ...
            >
                ...
                <Grid item>
                    <Grid container direction="column" spacing={0.5} className={classes.ac}>
                        <Grid item>
                            <a href={IGSN_BASE_URL} title="IGSN Homepage" target="_blank" rel="noreferrer">
                                <img src={IGSNlogo} alt="IGSN Logo" title="IGSN Logo" className={classes.igsnLogo} />
                            </a>
                        </Grid>
                        <Grid item>
                                    ...
                                    {subFields(s).length > 0 &&
                                        subFields(s).map((sf) => (
                                            ...
                                            >
                                                ...
                                                <Grid item>
                                                    {sf.value ? sf.value : <em className={classes.grey}>None</em>}
                                                </Grid>
                                            </Grid>
                                        ))}
                                </Grid>
                    ...
                    {Array.isArray(identifier.descriptions) && identifier.descriptions.length > 0 && (
                        ...
                        >
                            ...
                            {identifier.descriptions.map((d) => (
                                <Grid container direction="row" className={classes.block} spacing={1} key={d.value}>
                                    <Grid item className={classes.key}>
                    ...
                    {Array.isArray(identifier.alternateIdentifiers) && identifier.alternateIdentifiers.length > 0 && (
                        ...
                        >
                            ...
                            {identifier.alternateIdentifiers.map((id) => (
                                <Grid container direction="row" className={classes.block} spacing={1} key={id.value}>
                                    ...
                                    {subFields(id).length > 0 &&
                                        subFields(id).map((sf) => (
                                            ...
                                            >
                                                ...
                                                <Grid item>{sf.value ? sf.value : <em>None</em>}</Grid>
                                            </Grid>
                                        ))}
                                </Grid>
                            ))}
                        ...
                        >
                            ...
                            {identifier.dates.map((d, i) => (
                                ...
                                >
                                    ...
                                    <Grid item>{truncateIsoTimestamp(d.value, "date").orElse("Invalid date")}</Grid>
                                </Grid>
                            ))}
                        </Grid>
                    )}
                                                            ...
                                                            <>
                                                                ...
                                                                <dl className={classes.styledDescriptionList}>
                                                                    <DividedPair>
                                                                        <dt>Latitude</dt>
                                                                        <dd>
                                                                            {gl.geoLocationInPolygonPoint.pointLatitude}
                                                                            ˚
                                                                        </dd>
                                                                        <dt>Longitude</dt>
                                                                        <dd>
            ...
            {identifier.customFieldsOnPublicPage && (
                <>
                    ...
                    <Grid container direction="column" className={classes.block} spacing={2}>
                        <Grid item>
                            <Description
                                fieldOwner={{
                                                        ...
                                                        <TableRow key={f.id}>
                                                            ...
                                                            <TableCell>
                                                                {(f.selectedOptions?.join(", ") ??
                                                                    f.content?.toString()) || <NoValue label="None" />}
                                                            </TableCell>
                                                        </TableRow>
                                                    ))}
                                            </TableBody>
            ...
            <Grid container direction="row" className={clsx(classes.block, classes.bottomSpaced)} spacing={1}>
                <Grid item>
                    If you wish to obtain more information about this item, please contact the research data management
                    department at {institutionName}.
                    <br />
                    <br />
