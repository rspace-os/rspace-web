...
const Container = withStyles<{ topOfViewport?: boolean; children: React.ReactNode }, { topOfViewport: string }>(() => ({
    topOfViewport: {
        position: "fixed",
        top: 0,
        left: 0,
    ...
    ({
        ...
        <Grid
            ...
            className={clsx((topOfViewport === false || topOfViewport === null) && classes.topOfViewport)}
        >
            {children}
        </Grid>
    ),
