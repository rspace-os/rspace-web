...
const StyledPopover = styled(
    ({
        ...
        ...rest
    }: { highContrastMode: boolean } & React.ComponentProps<typeof Popover>) => <Popover {...rest} />,
)(({ highContrastMode }) => ({
    "& > .MuiPaper-root": {
        padding: "2px",
        maxWidth: "500px",
            ...
            <Stack spacing={0.25}>
                {supportsHighContrastMode && (
                    <Alert severity={highContrastModeIsEnabled ? "success" : "info"} elevation={0} aria-label="Tip">
                        ...
                        {highContrastModeIsEnabled ? "off" : "on"} your device&apos;s high contrast setting:
                        <br />
                ...
                {supportsReducedMotion && (
                    <Alert severity={reducedMotionModeIsEnabled ? "success" : "info"} elevation={0} aria-label="Tip">
                        ...
                        {reducedMotionModeIsEnabled ? "off" : "on"} your device&apos;s reduced motion setting:
                        <br />
                ...
                {supportsSkipToContent && (
                    <Alert severity="info" elevation={0} aria-label="Tip">
                        ...
                        Press the "Tab" key to access skip links that allow you to jump directly to main page sections
                        like navigation, content, and other landmarks.
                    </Alert>
                )}
            </Stack>
        </StyledPopover>
