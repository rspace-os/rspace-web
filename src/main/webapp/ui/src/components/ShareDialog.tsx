...
export function ShareDialog({ shareDialogConfig }: { shareDialogConfig: ShareDialogConfig | "FromGlobalEvent" }) {
    const shareDialogConfigFromHook = useSetup();
    const { open, onClose, globalIds, names } =
        shareDialogConfig === "FromGlobalEvent" ? shareDialogConfigFromHook : shareDialogConfig;
    ...
    }, [open, globalIds, getFolder, getGroups, getShareInfoForMultiple]);
    ...
    }, [open, currentUser, getFolder, getGroupMembers, getGroups]);
                                ...
                                globalIds.forEach((globalId) => {
                                    ...
                                    if (alreadyShared) {
                                        ...
                                        const newShare: NewShare = {
                                            ...
                                            recipientName:
                                                newValue.optionType === "GROUP" ? newValue.name : newValue.username,
                                            ...
                                            locationName:
                                                newValue.optionType === "GROUP"
                                                    ...
                                                    : null,
                                            locationId:
                                                newValue.optionType === "GROUP" && "sharedFolderId" in newValue
                                                    ? newValue.sharedFolderId
                                                    : null,
                                        };
                        ...
                        {globalIds.length === 1 ? (
                                                    ...
                                                    {notebookShares.length > 0 && (
                                                        <Box>
                                                            <Typography variant="body1" component="h3" gutterBottom>
                                                                As {docName} is shared into Notebooks, it is also shared
                                                                with:
                                                            </Typography>
                                                            <TableContainer
                                                                component={Paper}
                                                            ...
                                                            <Typography variant="body1" color="text.secondary">
                                                                Items in Notebooks inherit the Notebook's permissions.
                                                                Contact the notebook's owner to alter the notebook's
                                                                permissions.
                                                            </Typography>
                                                        </Box>
                                                    )}
                            ...
                            <>
                                ...
                                <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                                    Use the field above to add new shares. The share status of multiple documents can be
                                    edited on the <Link href="/record/share/manage">shared documents page</Link>.
                                </Typography>
                                {newShares.size > 0 && (
                                    <Box>
