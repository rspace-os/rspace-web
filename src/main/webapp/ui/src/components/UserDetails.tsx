...
export default function UserDetails(props: UserDetailsArgs): React.ReactNode {
    ...
    const listLabgroups = user?.groups.map((group) => (
        <TableRow key={group.groupId} data-test-id={`group-${group.groupId}-${group.roleInGroup}`}>
            <TableCell component="th" scope="row">
                {group.roleInGroup} at
            </TableCell>
            <TableCell align="right">
                <a data-test-id={`group-link-${group.groupId}`} href={`/groups/view/${group.groupId}`}>
                    {group.groupName}
                </a>
            </TableCell>
        </TableRow>
                            ...
                            <Table>
                                <TableBody>
                                    <TableRow data-test-id="row-email">
                                        ...
                                        <TableCell align="right">
                                            <a href={`mailto:${user.email}`} data-test-id="send-email">
                                                {user.email}
                                            </a>
                                        </TableCell>
                                    </TableRow>
