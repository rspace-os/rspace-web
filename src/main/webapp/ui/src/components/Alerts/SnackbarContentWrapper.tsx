...
const SnackbarContentWrapper = forwardRef<HTMLDivElement, SnackbarContentWrapperArgs>(
    (
        { className, onClose, alert, expanded, setExpanded, onInteraction, ...other }: SnackbarContentWrapperArgs,
        ref,
    ) => {
                ...
                <Grid container wrap="nowrap">
                    <Grid item>
                        <Badge
                            ...
                            classes={{
                                badge: clsx(classes.badge, alert.variant === "success" && classes.successBadge),
                            }}
                            color="error"
                            aria-hidden="true"
                        >
                            {alert.icon ?? <Icon className={clsx(classes.icon, classes.iconVariant)} />}
                        </Badge>
                    </Grid>
                    <Grid item>
                        <Box
                ...
                <Box mt={2}>
                    <Grid container spacing={1} className={classes.alertContainer}>
                        ...
                        {alert.detailsCount > alert.details.length && (
                            <Grid item xs={12}>
                                <Alert className={classes.detailedAlert} severity={alert.variant}>
                                    <Box className={classes.detailedText}>
