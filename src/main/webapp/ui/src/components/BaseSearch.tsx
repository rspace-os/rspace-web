...
function BaseSearch(props: {
    ...
    return (
        <Paper className={classes.paper} variant={props.variant} data-test-id="base-search-content">
            <form onSubmit={submitSearch} className={classes.form} data-test-id="base-search-form">
                <InputBase
                    id={props.elId}
