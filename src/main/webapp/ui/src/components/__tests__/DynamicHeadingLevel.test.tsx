...
describe("DynamicHeadingLevel", () => {
    ...
    test("Variant should change css styles but leave element type untouched.", () => {
        ...
        expect(screen.getByRole("heading", { name: /Test/, level: 2 }).className).toMatch(/MuiTypography-h5/);
    });
    ...
    test("Variant should default to the level.", () => {
        ...
        expect(screen.getByRole("heading", { name: /Test/, level: 3 }).className).toMatch(/MuiTypography-h3/);
    });
});
