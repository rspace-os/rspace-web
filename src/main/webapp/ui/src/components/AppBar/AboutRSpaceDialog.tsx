...
export function AboutRSpaceContent(): React.ReactElement {
    ...
    return (
        <Box display="flex" flexDirection="column" alignItems="center" py={2}>
            <Box width={80} height={80} mb={2} display="flex" alignItems="center" justifyContent="center">
            ...
            <Typography variant="body2" align="center" color="textSecondary" gutterBottom>
                ...
                <Link href="mailto:support@researchspace.com">support@researchspace.com</Link>
            </Typography>
