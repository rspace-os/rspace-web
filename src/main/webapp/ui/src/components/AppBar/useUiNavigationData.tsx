                ...
                .flatMap((obj) => {
                    try {
                        ...
                        const orcidAvailable = Parsers.objectPath(["userDetails", "orcidAvailable"], obj)
                            ...
                            .elseThrow();
                        const fullName = Parsers.objectPath(["userDetails", "fullName"], obj)
                            .flatMap(Parsers.isString)
                            .elseThrow();
                        const username = Parsers.objectPath(["userDetails", "username"], obj)
                            .flatMap(Parsers.isString)
                            .elseThrow();
                        ...
                        const bannerImgSrc = Parsers.objectPath(["bannerImgSrc"], obj)
                            .flatMap(Parsers.isString)
                            .elseThrow();
                        const extraHelpLinks: UiNavigationData["extraHelpLinks"] = Parsers.objectPath(
                            ["extraHelpLinks"],
                            obj,
                        )
