        ...
        await use({
            ...
            "a table listing Alice and Bob's group as a group with whom the document is shared should be visible":
                async () => {
                    ...
                    await expect(row).toBeVisible();
                    await expect(
                        row.getByRole("cell").getByRole("button", { name: /^Alice and Bob's Group$/ }),
                    ).toBeVisible();
    ...
    test.describe("Updating shares", () => {
        ...
        feature(
            ...
            async ({ Given, When, Then }) => {
                ...
                await When["the user saves the new share"]();
                Then["a PUT request should have been made to update the group's permission to {newPermission}"]({
                    newPermission: "READ",
                });
            },
        );
        ...
        feature(
            ...
            async ({ Given, When, Then }) => {
                ...
                await When["the user saves the new share"]();
                Then["a POST request should have been made to move the document to the new folder"]();
            },
        );
    });
});
