...
const mockAvailableRaIDListSuccess: GetAvailableRaIDList = {
  success: true,
...
describe("getAvailableRaidIdentifiersAjax", () => {
  ...
  it("should handle empty RaID list successfully", async () => {
    const mockAvailableRaIDListEmpty: GetAvailableRaIDList = {
      success: true,
      data: [],
    };
  ...
  it("should handle failure response from server", async () => {
    const mockAvailableRaIDListFailure: GetAvailableRaIDList = {
      success: false,
      error: {
        errorMessages: [
          {
...
describe("getRaidIntegrationInfoAjax", () => {
  it("should fetch RaID integration info successfully", async () => {
    ...
    expect(result).toEqual(mockIntegrationInfoSuccess);
    expect(result.success).toBe(true);
    if (result.success) {
