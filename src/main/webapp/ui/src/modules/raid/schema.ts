...
export type GetAvailableRaIDList = v.InferOutput<
...
export const IntegrationRaidInfoDataSchema = v.object({
  ...
  options: v.objectWithRest(
    {
      RAID_CONFIGURED_SERVERS: v.array(RaIDConfiguredOptionValueSchema),
    },
...
export type DeleteRaidIdentifierAssociation = true | AjaxOperationFailure;
