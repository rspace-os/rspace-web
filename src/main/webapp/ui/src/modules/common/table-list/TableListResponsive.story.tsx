...
import { TableListCardGrid } from "./components/TableListCardView";
...
export function NarrowCardGridStory() {
  const title = "An instrument with a long one-line location and descriptive name";
  const actionLabel = "Open";
  return (
    <div className="@container/table-list" style={{ width: 320 }}>
      <TableListCardGrid
        label="Research records cards"
        items={[
          {
            id: "long-title",
