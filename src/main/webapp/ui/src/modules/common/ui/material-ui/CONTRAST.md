...
The Chromium run on 2026-09-07 after further story refinements reported **394 passing and 81 failing
stories across 76 files**. All remaining failures reported axe's
`color-contrast` rule. These are 81 failing stories, not 86 distinct color
...
| --- | --- | --- | --- |
| `#00adef` | `#fafafa` | 2.44:1 | Link, Tabs, Typography |
...
The 22 affected families and their failing-story counts were: AppBar 7,
...
Link 7, Menu 3, Modal 4, Popover 1, Snackbar 3, Stepper 3, Tabs 8,
