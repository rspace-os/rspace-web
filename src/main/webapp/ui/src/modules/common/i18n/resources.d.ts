...
export default interface Resources {
  ...
  "inventory": {
    ...
    "requests": {
      ...
      "blocked": {
        "body": "The owner has not made this sample requestable.",
        "title": "Not available for request"
      },
      "detail": {
        "back": "All requests",
        "title": "Request {id}"
      },
      "empty": "No requests have been raised against this sample.",
      "fulfil": {
        "approve": "Approve",
        "close": "Close",
        "closeDialog": "Close dialog",
        "confirmReject": "Confirm rejection",
        "doneBody": "{produced} ({producedId}) is owned by {name}, with lineage back to {globalId} intact. {firstName} has been notified.",
        "fulfilledTitle": "{id} fulfilled",
        "noReason": "No reason given",
        "notNow": "Not now",
        "operationLabel": "Process operation",
        "operationTitle": "Process operation · {id}",
        "ops": {
          "aliquot": {
            "body": "Take material from an origin subsample of {globalId}. Create a new sample with subsamples and an IsPartOf link to the origin.",
            "label": "Aliquot"
          },
          "derive": {
            "body": "Name the process and create a new sample with subsamples and an IsDerivedFrom link to the origin subsample.",
            "label": "Derive"
          }
        },
        "opsInfo": "Prototype of RSDEV-1231 operation effects. Amounts use mL; the new sample has no template or SOP link. The full wizard offers template and documentation steps. Created quantities are independent of the amount consumed. No API call is made here.",
        "plan": {
          "amountTaken": "Amount taken from origin (mL)",
          "count": "Number of new subsamples",
          "eachAmount": "Amount per new subsample (mL)",
          "invalid": "Choose an available origin, a sample name, and a process name for Derive. Create 1–100 subsamples. Amounts must be positive with at most three decimal places; do not take more than the origin holds.",
          "name": "New sample name",
          "origin": "Origin subsample",
          "process": "Process name",
          "result": "Created {count} subsamples of {eachAmount} mL each. The new sample links to {origin} with {relation}. Consumed {amountTaken} mL; {remaining} mL remained after preparation.",
          "summary": "Confirm: create a new sample with {count} subsamples of {amount} mL each; consume {taken} mL from {origin}. Write {relation} on the new sample, pointing to {origin}. Transfer ownership separately after preparation succeeds."
        },
        "preparedBody": "{produced} ({producedId}) was created from {globalId} with lineage intact, but it is still yours. Transfer ownership to fulfil the request; {firstName} is notified then.",
        "preparedTitle": "Material prepared · {id}",
        "reject": "Reject",
        "rejectReasonLabel": "Reason for rejection",
        "rejectReasonPlaceholder": "Kept on the request and written to the audit trail.",
        "requestMeta": "{id} · {username} · {when}",
        "reviewTitle": "Review request {id}",
        "runOperation": "Run operation",
        "sourceItem": "Source item: {globalId} {name}",
        "transfer": "Transfer ownership",
        "transferTitle": "Transfer the new sample and all its subsamples to {name}",
        "transferred": "Transferred"
      },
      "list": {
        "columns": {
        ...
        "empty": {
          "incoming": "No requests have been raised against your items.",
          "outgoing": "You have not requested any material."
        },
        "tabs": {
          "incoming": "To review",
      ...
      "mine": {
        "received": "Owned by you · IsDerivedFrom {globalId}",
        "steps": {
          "approved": {
            "done": "Approved by {owner}.",
            "title": "Approved",
            "waiting": "A human owner reviews every request."
          },
          "fulfilled": {
            "done": "{produced} is in your Inventory. The request is complete.",
            "title": "Fulfilled. Ownership transferred",
            "waiting": "The request is only fulfilled once the material is yours."
          },
          "pending": {
            "body": "Raised against {globalId}. The owner was notified.",
            "title": "Pending"
          },
          "prepared": {
            "done": "{produced} produced from {globalId} with lineage recorded.",
            "title": "Material prepared",
            "waiting": "The owner runs a process operation to produce the material."
          }
        },
        "subtitle": "Material from {globalId} · {name}",
      ...
      "outcome": {
        "fulfilled": "Fulfilled. Ownership transferred to {name}.",
        "prepared": "{globalId} prepared. Not fulfilled until ownership transfers.",
        "rejected": "Rejected. {reason}"
      },
      "pendingCount": "{count} pending",
      "quoted": "“{note}”",
      "request": {
        "explanation": "{owner} reviews every request and produces the material. Nothing is issued automatically.",
        "noteLabel": "What you need",
        "notePlaceholder": "Say what you need and what for. The owner reads this to decide what to produce.",
        "recordedAgainst": "Recorded against {globalId}",
        "send": "Send request",
        "title": "Request material"
      },
      "requestableChip": "Requestable",
      "sectionTitle": "Requests",
      "status": {
        "approved": "Approved",
        "fulfilled": "Fulfilled",
        "pending": "Pending",
        "prepared": "Awaiting transfer",
        "rejected": "Rejected"
      },
      "toggle": {
        "label": "Available for request",
        "off": "Off. This sample is not offered to other researchers.",
        "on": "Anyone on this RSpace instance can raise a request. You review each one and fulfil it by transferring the material.",
  ...
  "server.admin": {
    ...
    "audit": {
      ...
      "heading": "Auditing",
      "scopeHeading": {
        "community": "Audit: My Community''s RSpace Activity",
        "global": "Audit: Global RSpace Activity",
        "group": "Audit: My LabGroup''s RSpace Activity",
        "user": "Audit: My RSpace Activity"
      },
      "title": "Auditing"
    },
    "cloud": {
    ...
    "directory": {
      ...
      "noResults": {
        "emptySearchResults": "No users were found. Please try searching again."
      },
      "projectGroupList": {
    ...
    "header": {
      "runAs": {
        "activeBanner": "Currently operating as {0}."
      },
    ...
    "group": {
      "created": {
        "success": {
          ...
          "currentPiSummary": "You have created a group called {0}.{1, select, true { The following people have been invited to join the group:} other {}}",
          "heading": "Congratulations!",
          "nominationSummary": "You have initiated a group called {0} and nominated {1} to be Principal Investigator.{2, select, true { When this nomination is accepted, the following people will be invited to join the group.} other {}}",
          "title": "Group created"
        }
      }
    }
  ...
  "server.core": {
    ...
    "errors": {
      ...
      "authorization": {
        ...
        "failure": {
          "accessMediaFile": "Unauthorized attempt by {0} to access media file [{1}]",
          "addToFolder": "Unauthorized attempt by {0} to add an item to a folder",
          "changeGroupMemberRole": "Unauthorized attempt by {0} to change the role of user {1} in group {2}",
          "changeGroupPiEditPermission": "Unauthorized attempt by {0} to change {1}''s edit-all-work permission in group {2}",
          "changePiEditAllSetting": "Unauthorized attempt by {0} to change the PI edit-all-work setting in group {1}",
          "changeUserEnabledState": "Unauthorized attempt by {0} to change a user''s enabled state",
          "createFolderIn": "Unauthorized attempt by {0} to create a folder in [{1}]",
          "createGroupWithoutCommunity": "Unauthorized attempt by {0} to create a group. Please ask to be assigned to a community.",
          "createRequest": "Unauthorized attempt by {0} to create a request of type {1}",
          "downloadSignedExports": "Unauthorized attempt by {0} to download signed exports",
          "editFirstName": "Unauthorized attempt by {0} to edit their first name",
          "editFormDescription": "Unauthorized attempt by {0} to edit a form description",
          "editGroup": "Unauthorized attempt by {0} to edit a group",
          "editLastName": "Unauthorized attempt by {0} to edit their last name",
          "exportRecordsOfUser": "Unauthorized attempt by {0} to export records belonging to {1}",
          ...
          "removeUserFromGroup": "Unauthorized attempt by {0} to remove a user from a group",
          "renameForm": "Unauthorized attempt by {0} to rename a form",
          ...
          "revokeGlobalPiRole": "Unauthorized attempt by {0} to revoke the global PI role",
          "saveAnnotation": "Unauthorized attempt by {0} to save an annotation",
          "saveChemicalStructure": "Unauthorized attempt by {0} to save a chemical structure",
          "saveMathEquation": "Unauthorized attempt by {0} to save a maths equation",
          "saveSketch": "Unauthorized attempt by {0} to save a sketch",
    ...
    "validation": {
      "errors": {
        ...
        "descriptionStringMax": "Description \"${validatedValue}\" must be less than {max} characters.",
        ...
        "licenseNameStringRange": "License name \"${validatedValue}\" must be between {min} and {max} characters.",
        "licenseUrlRequired": "License URL is a required field.",
        "licenseUrlStringMax": "License URL \"${validatedValue}\" must be less than {max} characters.",
        "maxLinkLevelRequired": "maxLinkLevel is a required field.",
        "nameRange": "Name \"${validatedValue}\" must be between {min} and {max} characters.",
    ...
    "email": {
      "notification": {
        ...
        "request": {
          ...
          "joinInstruction": "In order to join the {0, select, labGroup {Lab Group} other {Project Group}} \"<b>{1}</b>\", click to <a href=\"{2}\" rel=\"nofollow\" target=\"_blank\" class=\"word-wrap\">ACCEPT</a> or <a href=\"{3}\" rel=\"nofollow\" target=\"_blank\" class=\"word-wrap\">REJECT</a> this invitation, then log in to RSpace with your credentials.",
  ...
  "server.groups": {
    ...
    "groups": {
      ...
      "sharing": {
        ...
        "sharedForEditInto": "Shared for edit into {0}",
        "table": {
          "actions": "Actions",
          "description": "Description",
      ...
      "view": {
        ...
        "heading": "{0, select, COLLABORATION_GROUP {Collaboration Group: {1}} PROJECT_GROUP {Project Group: {1}} other {Group: {1}}}",
        "homeFolder": {
    ...
    "legacyjs": {
      ...
      "core": {
        ...
        "share": {
          ...
          "noneShared": "{0, select, publication {{1, plural, one {Document not published} other {Documents not published}}} other {{1, plural, one {Document not shared} other {Documents not shared}}}}",
          "notAll": "{0, select, publication {Not all documents were published} other {Not all documents were shared}}",
          "publicationSuccess": "{0, plural, one {Document published.} other {# documents published.}}{1, select, button { There is a copy button at the top left of this screen which will copy document names with their published links to your clipboard.} clipboard { Document names with their published links are in your clipboard.} other {}}",
          "publish": "Publish",
          "publishDidNotComplete": "Publishing did not complete. {0}",
          "publishing": "{0, plural, one {Publishing document} other {Publishing documents}}"
        },
        "template": {
        ...
        "useTemplate": {
          "folderChooserPrompt": "{0} to put the document there.",
  ...
  "server.system.community": {
    "community": {
      ...
      "directoryHeading": "Community: {0}, Created: {1}",
      "displayName": {
        "label": "Display name"
      },
      "editForm": {
      ...
      "heading": "{0} <span style=\"font-size: initial\">(created: {1})</span>",
      "invitation": {
        "errors": {
  ...
  "server.workspace": {
    ...
    "requestFeedback": {
      "memberOfGroupNotice": "Request <b>accepted</b>! - you''re now a member of \"{0}\" group",
      "notJoiningGroupNotice": "Request <b>declined</b>! - you''re not joining the group \"{0}\"",
