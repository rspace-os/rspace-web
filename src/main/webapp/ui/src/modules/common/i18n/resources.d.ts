    ...
    "requestsManagement": {
      ...
      "detail": {
        ...
        "transferDialog": {
          ...
          "otherRequestsHint": "Other Pending or Approved requests from other users will be closed automatically when this sample is transferred.",
          "subsamplesHint": "Transferring this sample will also transfer all subsamples."
        },
