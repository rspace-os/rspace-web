...
const meta = {
  ...
  args: {
    item: {
      ...
      globalId: "IN123",
      location: { name: "Lab 2.14", globalId: "IC456" },
    },
...
export const ManyEventsInOneSlice: Story = {
  args: {
    intervals: Array.from({ length: 12 }, (_, index) =>
      sourced(`booking:${index + 10}`, "booking", "2026-08-12T09:00:00.000Z", "2026-08-12T11:00:00.000Z"),
    ),
  },
};
