...
function formatMinute(date: string, timezone: string, minute: number) {
  return dayMinuteToZonedTime(date, timezone, minute).toPlainTime().toString({ smallestUnit: "minute" });
}

function dateForMinute(date: string, timezone: string, minute: number) {
...
function formatMinuteWithDayOffset(date: string, timezone: string, minute: number) {
...
function period(event: DayTimelineEvent, date: string, timezone: string) {
