...
function AddBookingForm({
  ...
  return (
    <Form of={form} className="contents" onSubmit={() => undefined}>
      ...
      {/* Priority order for overflow; placement is the bar's job. Cancel is declared by role, so it
          takes the leading edge and submitting lands on the trailing one, as an iOS alert does. */}
      <ActionBar
        actions={[
          {
          ...
          { label: "Cancel", style: "cancel", onClick: onCancel },
        ]}
      />
    </Form>
  );
