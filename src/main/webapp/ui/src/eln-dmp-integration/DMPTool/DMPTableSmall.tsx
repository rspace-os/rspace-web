...
function PlanRow({ plan, selectedPlans, addSelectedPlan, removeSelectedPlan }: BodyRowArgs) {
    const { classes } = useStyles();

    const isCurrentlySelected = (id: DMPUserInternalId) => selectedPlans.includes(id);
    ...
    return (
        <TableRow
            className={clsx(classes.bottomBorder, classes.tableRow, classes.tableRowDesktop)}
