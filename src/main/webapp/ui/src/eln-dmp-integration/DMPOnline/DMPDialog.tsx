...
import { type GridRowId, GridToolbarColumnsButton, GridToolbarContainer } from "@mui/x-data-grid";
...
const useStyles = makeStyles<{ listing: FetchingData.Fetched<unknown> }>()(
    (_theme, props: { listing: FetchingData.Fetched<unknown> }) => ({
        table: {
            display:
                ...
                >
                    <Grid item>
                        <Typography variant="body2">
                            Importing a DMP from <strong>dmponline.dcc.ac.uk</strong> will make it available to view and
