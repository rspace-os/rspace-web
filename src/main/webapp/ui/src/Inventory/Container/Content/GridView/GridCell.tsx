...
const StyledCell = styled(
    React.forwardRef<HTMLTableCellElement, StyledCellProps & React.ComponentProps<typeof TableCell> & { theme?: any }>(
        ({ width: _width, hoverEffect: _hoverEffect, ...rest }, ref) => <TableCell {...rest} ref={ref} />,
    ),
)(
    ({
        theme,
