...
}))(({ inline: _inline, selected: _selected, ...rest }: { inline: boolean; selected: boolean }) => <Badge {...rest} />);
...
function NumberedLocation({
    ...
    return (
        <StyledBadge badgeContent={number} showZero inline={inline} selected={selected}>
            <SvgIcon className={clsx(classes.largeIcon, inline && classes.inlineIcon)}>
                <path
