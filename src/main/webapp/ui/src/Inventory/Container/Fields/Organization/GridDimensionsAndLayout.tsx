...
const CustomContent = withStyles<React.ComponentProps<typeof CardContent>, { root: string }>((theme) => ({
    root: {
        ...
        <>
            ...
            <Box my={1}>
                <Card variant="outlined" role="region" aria-labelledby={headingId}>
                    <CustomHeader open={open} setOpen={setOpen} id={headingId} controls={contentId} />
