...
function OverviewSection({ collection, recordsCount }: { collection: ContainerCollection; recordsCount: number }) {
  ...
  return (
    <StepperPanel title="Overview" formSectionError={formSectionError} sectionName="overview" recordType="container">
...
function DetailsSection({ collection }: { collection: ContainerCollection }) {
  ...
  return (
    <StepperPanel title="Details" formSectionError={formSectionError} sectionName="details" recordType="container">
      <Description
        fieldOwner={collection}
...
function BatchForm({ records }: BatchFormArgs): ReactNode {
  ...
  return (
    ...
    >
      <StepperPanel title="Information" sectionName="information" recordType="container">
        <BatchEditingItemsTable records={records} label="Containers being edited" />
      </StepperPanel>
