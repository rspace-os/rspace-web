...
function Form(): React.ReactNode {
    ...
    return (
        <Stepper titleText={activeResult.name} resetScrollPosition={activeResult} factory={activeResult.factory}>
            <LimitedAccessAlert readAccessLevel={activeResult.readAccessLevel} owner={owner} whatLabel="sample" />
                    ...
                    {activeResult.state === "preview" ? (
                        ...
                        >
                            ...
                            <Typography variant="body1">
                                Tap one of the {activeResult.subSampleAlias.plural} in the search section to preview it
                                below.
                            </Typography>
