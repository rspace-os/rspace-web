                        ...
                        options={[
                            {
                                ...
                                label: (
                                    <>
                                        ...
                                        <OptionExplanation>
                                            The sample is made up of <strong>one subsample</strong>, representing the
                                            physical location of the sample. Sample actions are equivalent to subsample
                                            actions.
                                        </OptionExplanation>
                                    </>
                                ),
                            },
                            {
                                ...
                                label: (
                                    <>
                                        ...
                                        <OptionExplanation>
                                            The sample is made up of <strong>multiple subsamples</strong>, which
                                            represent related physical items originating from the same source. Sample
                                            actions affect the entire group of subsamples.
                                        </OptionExplanation>
                                    </>
                                ),
                            },
