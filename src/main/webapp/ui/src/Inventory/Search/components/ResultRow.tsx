    ...
    return {
        tableRow: {
            ...
            "&.Mui-selected": {
                ...
                "& .MuiCheckbox-root": {
                    color: prefersMoreContrast ? theme.palette.primary.contrastText : undefined,
                },
            },
            "&.Mui-selected:hover": {
...
function ResultRow({ result, adjustableColumns }: ResultRowArgs): React.ReactNode {
    ...
    return (
        <TableRow
            ...
            tabIndex={-1}
            className={clsx(classes.tableRow, search.alwaysFilterOut(result) && globalClasses.greyOut)}
