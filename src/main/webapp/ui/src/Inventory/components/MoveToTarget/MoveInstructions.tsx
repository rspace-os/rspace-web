            ...
            {showDragAndDropTip && (
                <Alert severity="info" sx={{ fontSize: "0.8rem", letterSpacing: "0.015em" }}>
                    <AlertTitle sx={{ fontSize: "0.85rem" }}>
                        Tip: when rearranging the contents of grid containers you can simply drag-and-drop them into
                        their new locations.
                    </AlertTitle>
                    Select one or more grid cells in the container&apos;s &quot;Locations and Content&quot; section and
                    then tap and hold to enter drag-and-drop mode.
                </Alert>
            )}
        </Stack>
    );
