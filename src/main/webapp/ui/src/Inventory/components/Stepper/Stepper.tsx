...
const Wrapper = React.forwardRef<HTMLDivElement, WrapperProps>(({ children }, ref) => <div ref={ref}>{children}</div>);
    ...
    const Title = (
        <Stack direction="row" spacing={1}>
            <Typography
                variant="h5"
                component="h2"
                className={clsx(classes.rightSpacing, needsTruncating && classes.truncatedTitle)}
