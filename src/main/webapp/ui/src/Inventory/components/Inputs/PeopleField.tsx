...
const RecipientTextField = ({ InputProps, loading, label, ...rest }: RecipientTextFieldArgs) => (
    <TextField
        {...rest}
        variant="outlined"
        autoFocus
...
function PeopleField({
    ...
    }, [peopleStore.currentUser, addAlert, handleUserChange, ownedBy, owner, peopleStore.fetchMembersOfSameGroup]);
    ...
    return (
        <CustomAutocomplete
            ...
            renderInput={(props) => <RecipientTextField {...props} loading={loading} label={label} />}
            size="small"
            value={recipient}
