...
import type { AllowedSearchModules, AllowedTypeFilters } from "../../../stores/definitions/Search";
...
const LocationPicker = observer(({ id: _id, state }: { id: string; state: { container: Container } }) => {
    const search = React.useMemo(() => {
         ...
         */
    }, [state.container.cType, state.container.globalId]);
...
function CreateDialog({ existingRecord, open, onClose }: CreateDialogProps): React.ReactNode {
    ...
    }, [open, existingRecord, addAlert, onClose]);
                ...
                <DialogActions>
                    ...
                    <SubmitSpinner
                        ...
                        disabled={
                            ...
                            selectedCreateOptionIndex === null ||
                            activeStep <
                                (existingRecord.createOptions[selectedCreateOptionIndex].parameters ?? []).length ||
