                    ...
                    <InputWrapper label={`Point ${i + 1} Latitude`}>
                        {editable && i < geoLocationPolygon.length - 1 ? (
                            <AmberNumberField
                                ...
                                variant="standard"
                                fullWidth
                                // @ts-expect-error - using datatestid instead of data-testid to maintain backward compatibility
                                ...
                                helperText={
                                    polygonPointLatitudeError(point) ? <>Between &minus;90.0˚ and 90.0˚.</> : null
                                }
                            />
                        ) : (
                    ...
                    <InputWrapper label={`Point ${i + 1} Longitude`}>
                        {editable && i < geoLocationPolygon.length - 1 ? (
                            <AmberNumberField
                                ...
                                helperText={
                                    polygonPointLongitudeError(point) ? <>Between &minus;180.0˚ and 180.0˚.</> : null
                                }
                            />
                        ) : (
                            /* last point is edited by editing first */
                ...
                <Grid item md={5}>
                    <InputWrapper label={`In Polygon Point Latitude`}>
                        {editable ? (
                            ...
                            geoLocationInPolygonPoint.pointLatitude || <span style={{ color: "#949494" }}>-</span>
                        )}
                    </InputWrapper>
                </Grid>
                <Grid item md={5}>
                    <InputWrapper label={`In Polygon Point Longitude`}>
                        {editable ? (
                            ...
                            geoLocationInPolygonPoint.pointLongitude || <span style={{ color: "#949494" }}>-</span>
                        )}
                    </InputWrapper>
                </Grid>
            </Grid>
            ...
            <CardContent sx={{ pt: 1 }}>
                <FormControl component="fieldset" fullWidth>
                    ...
                    <FormHelperText component="div" sx={{ mx: 0, mt: 1 }}>
                        You can add a Polygon to a Geolocation associated with an IGSN ID. A Polygon is made of 4 or
                        more points that form a closed shape. The first and last points have the same coordinates,
                        editing the first point will automatically update the last one.
                    </FormHelperText>
                    <Box sx={{ my: 1 }}>
                        <PolygonStateAlert
                    ...
                    <FormHelperText component="div" sx={{ mx: 0, mt: 1, mb: 0.5 }}>
                        Optional: you can specify an In Polygon Point below. This is only required if the Polygon covers
                        more than the half of the Earth&apos;s surface.
                    </FormHelperText>
