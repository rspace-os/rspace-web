            ...
            match<void, string | null>([
                ...
                [
                    () => {
                        ...
                        return (
                            extraField.owner.fieldNamesInUse.filter((n) => n === value).length > Number(unchangedName)
                        );
                    },
        ...
        <>
            {extraField && (
                <Grid
                    ...
                    role="group"
                    aria-label={
                        extraField.id === null ? "New extra field" : `Editing extra field with name ${extraField.name}`
                    }
                >
                    <Grid item md={7} xs={12}>
                        <FormField
                            ...
                            label="Field name"
                            renderInput={(props) => (
                                <TextField {...props} variant="standard" onChange={handleNameChange} />
                            )}
                            maxLength={255}
                    ...
                    <Grid item md={12} xs={12}>
                        ...
                        <Button
                            ...
                            onClick={() =>
                                extraField.initial ? record.removeExtraField(null, index) : discardChanges()
                            }
