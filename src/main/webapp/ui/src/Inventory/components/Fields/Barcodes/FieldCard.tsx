...
const DescriptionWrapper = withStyles<{ children: ReactNode; isDeleted: boolean }, { root: string }>(
    (_theme, { isDeleted }) => ({
        root: {
                ...
                <CustomCardHeader
                    ...
                    action={
                        <>
                            ...
                            <ToggleButton barcodeCount={barcodes.length} open={open} setOpen={setOpen} />
                        </>
                    }
                />
            )}
