    ...
    return (
        <Grid container direction="column">
                ...
                {!value && (
                    <Box mt={1}>
                        <Alert severity="info" role="none">
                            <AlertTitle>Attachment</AlertTitle>A file of any type can be attached (e.g. image, document,
                            or chemistry file)
                        </Alert>
                    </Box>
                )}
            ...
            {!disableFileUpload && !disabled && (
                /* this should be disabled, no? what is disableFileUpload? */ <Grid item sx={{ mt: 1 }}>
                            ...
                            <React.Suspense fallback={<></>}>
                                <GalleryPicker
                                    ...
                                    validateSelection={(file) =>
                                        file.isSnippet
                                            ? Result.Error([
                                                  new Error("Snippets cannot be attached to Inventory records."),
                                              ])
                                            : Result.Ok(null)
                                    }
                                />
