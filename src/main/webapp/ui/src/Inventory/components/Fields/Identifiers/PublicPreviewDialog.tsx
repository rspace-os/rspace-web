...
const missingDataAlert: string = "Some required details are missing. To enable publishing, please fill them in.";

/**
 * Alert to display when required identifier data is missing
 */
export const MissingDataAlert = ({ className }: { className?: string }): React.ReactNode => {
    return (
