 ...
 * invalid state.
 */
const AmberNumberField: ComponentType<NumberFieldArgs> = withStyles<NumberFieldArgs, { root: string }>((theme) => ({
    root: {
        /*
...
}))(({ classes, ...props }) => <NumberField {...props} className={classes.root} />);
