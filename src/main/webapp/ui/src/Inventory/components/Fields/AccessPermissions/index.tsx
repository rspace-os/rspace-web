...
const CustomFormControlLabel = withStyles<React.ComponentProps<typeof FormControlLabel>, { root: string }>(() => ({
    root: {
    ...
    return (
        <>
            ...
            <FormControl
                ...
                explanation={
                    <>
                        Specify who will have full view and edit access to this item using the options below. See the
                        ...
                        {(fieldOwner.isFieldEditable("sharingMode") ||
                            ...
                            <Grid item>
                                <CustomFormControlLabel
                                    value="OWNER_GROUPS"
                                    control={
                                        <Radio color="primary" disabled={!fieldOwner.isFieldEditable("sharingMode")} />
                                    }
                                    label={
                                        <Box m={1} mt={0.5}>
                                            <Grid container direction="column" spacing={1}>
                                                <Grid item>
                                                    ...
                                                    <OptionExplanation>
                                                        Accessible to only those who are in a lab or collaboration group
                                                        with the owner.{" "}
                                                        {!hideOwnersGroups && (
                                                            <>
                                                                This table lists the groups that the owner is a member
                                                                of.
                                                            </>
                                                        )}
                                                    </OptionExplanation>
                                        ...
                                        <Box m={1} mt={0.5}>
                                            <Grid container direction="column" spacing={1}>
                                                <Grid item>
                                                    ...
                                                    <OptionExplanation>
                                                        Accessible to only those who are in a lab or collaboration group
                                                        that is listed in the table below, which can be any group in the
                                                        system.
                                                    </OptionExplanation>
                                                </Grid>
                                                <Grid item>
