...
const useStyles = makeStyles<{ isSingleColumnLayout: boolean }>()((theme, { isSingleColumnLayout }) => ({
    content: {
        padding: "0 !important",
        overflowX: "hidden",
        /*
            ...
            <DialogContent dividers className={classes.content}>
                <Grid container className={classes.container}>
                    <Grid
                        ...
                        className={clsx(
                            classes.leftPane,
                            isSingleColumnLayout && !(uiStore.dialogVisiblePanel === "left") && classes.hide,
                        )}
                    >
                        {props.colLeft}
                    </Grid>
                    <Grid
                        ...
                        className={clsx(
                            classes.rightPane,
                            isSingleColumnLayout && !(uiStore.dialogVisiblePanel === "right") && classes.hide,
                        )}
                    >
                        {props.colRight}
                    </Grid>
