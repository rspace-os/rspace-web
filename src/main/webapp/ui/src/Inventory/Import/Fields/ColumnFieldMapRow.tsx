...
const CustomTableRow = withStyles<React.ComponentProps<typeof TableRow> & { open: boolean }, { root: string }>(
    (theme, { open }) => ({
        root: {
            "&:hover": {
        ...
        <>
            ...
            {!existingTemplate && (
                <TableRow className={classes.extendedSection}>
                    <TableCell borderless={!open} colSpan={5} className={classes.extendedSectionCell}>
