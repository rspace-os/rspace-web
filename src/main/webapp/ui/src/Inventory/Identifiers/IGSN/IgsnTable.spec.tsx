    ...
    Then: async ({ page, networkRequests }, use) => {
        await use({
            ...
            "there should be a network request with state set to 'draft'": () => {
                expect(networkRequests.find((url) => url.searchParams.has("state"))?.searchParams.get("state")).toBe(
                    "draft",
                );
            },
            ...
            "there should be a network request with searchTerm set to 'test'": () => {
                expect(
                    networkRequests
                        .find(
                            (url) =>
                                url.searchParams.has("identifier") && url.searchParams.get("identifier") === "test",
                        )
...
test.describe("IGSN Table", () => {
    ...
    feature("Searching makes API call with searchTerm parameter", async ({ Given, When, Then }) => {
        ...
        void Then["there should be a network request with searchTerm set to 'test'"]();
    });
    ...
    feature("Filtering by state makes API call with state parameter", async ({ Given, When, Then }) => {
        ...
        void Then["there should be a network request with state set to 'draft'"]();
    });
    ...
    feature("Filtering by linked item makes API call with isAssociated parameter", async ({ Given, When, Then }) => {
        ...
        void Then["there should be a network request with isAssociated set to 'false'"]();
    });
    ...
    feature("Control defaults are applied to the table when provided", async ({ Given, Once, Then }) => {
        ...
        Then["there should be a network request with isAssociated set to 'false'"]();
