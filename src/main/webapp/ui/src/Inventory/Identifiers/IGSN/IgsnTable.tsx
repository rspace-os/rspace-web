...
export default function IgsnTable({
    ...
    const [state, setState] = React.useState<"draft" | "findable" | "registered" | null>(
        ...
        columns: [
            ...
            DataGridColumn.newColumnWithFieldName<"associatedGlobalId", Identifier>("associatedGlobalId", {
                ...
                renderCell: ({ row }) => {
                    ...
                    return (
                        <GlobalId record={new LinkableRecordFromGlobalId(row.associatedGlobalId)} onClick={() => {}} />
                    );
                },
            }),
        ],
    ...
    return (
        <DataGrid
            ...
            onRowSelectionModelChange={(ids: GridRowSelectionModel) => {
                const selectedIdentifiers = identifiers.filter((id) => ids.includes(id.doi));
