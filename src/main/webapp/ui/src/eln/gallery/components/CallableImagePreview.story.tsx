...
function TestComponent() {
    ...
    return (
        <Stack spacing={2}>
            <Button
                onClick={() => openImagePreview("https://via.placeholder.com/800x600/0066cc/ffffff?text=Test+Image")}
            >
                Open Image Preview
            </Button>
            <Button
            ...
            <Button
                onClick={() => openImagePreview("https://via.placeholder.com/400x300/cc0066/ffffff?text=Small+Image")}
            >
                Open Small Image
            </Button>
        </Stack>
...
function TestComponentWithLargeImage() {
    ...
    return (
        <Button
            onClick={() => openImagePreview("https://via.placeholder.com/2000x1500/009900/ffffff?text=Large+Image")}
        >
