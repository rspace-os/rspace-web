...
const CustomFieldset = withStyles<{ children: React.ReactNode }, { root: string }>((theme) => ({
    root: {
...
}))(({ classes, children }: { children: React.ReactNode; classes: { root: string } }) => (
                                    ...
                                    <>
                                        <Grid item>
                                            <Typography variant="body2">
                                                ...
                                                . By default, the items will be added to iRODS and removed from RSpace.
                                                You will be able to link to the iRODS items inside of RSpace documents
                                        ...
                                        {showUsernamePasswordForm && (
                                            <Grid item>
                                                <CustomFieldset>
                                                    ...
                                                    <Stack spacing={1}>
                                                        <Typography variant="body2">
                                                            Please provide your login credentials for {serverUrl}
                                                        </Typography>
                                                        <FormField
                                                            label="Username"
                                                            value={username}
