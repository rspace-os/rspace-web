...
const AddButton = styled(({ drawerOpen, ...props }: { drawerOpen: boolean } & React.ComponentProps<typeof Button>) => (
    <Button
        {...props}
        fullWidth
...
const Sidebar = ({
    ...
    return (
        ...
        >
            <Box width="100%" p={1.5}>
                <AddButton onClick={(e) => setNewMenuAnchorEl(e.currentTarget)} drawerOpen={drawerOpen} />
                <StyledMenu
