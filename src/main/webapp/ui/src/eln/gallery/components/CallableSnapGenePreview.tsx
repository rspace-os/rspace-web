    ...
    return (
        ...
        >
            <Stack direction="row" spacing={1}>
                ...
                <FormControlLabel
                    control={
                        <Switch checked={showEnzymes} onChange={({ target: { checked } }) => setShowEnzymes(checked)} />
                    }
                ...
                {!error && !loading && (
                    <>
                        <TableContainer style={{ maxHeight: "387px" }}>
                            <Table stickyHeader aria-labelledby="Enzyme table" size="small" aria-label="enhanced table">
                                <EnhancedTableHead
...
function ViewAsFasta({
    ...
    return (
        <section role="tabpanel" style={{ display: show ? "flex" : "none" }} aria-labelledby={idOfViewAsFastaTab}>
            <pre>{sequence}</pre>
        </section>
    );
}
                ...
                {!loading && !error && (
                    <>
                        <TableContainer style={{ maxHeight: "449px" }}>
                            <Table stickyHeader aria-labelledby="ORF table" size="small" aria-label="enhanced table">
                                <EnhancedTableHead
            ...
            <Grid item sx={{ minWidth: "200px" }}>
                <FormControl component="fieldset">
                    ...
                    <RadioGroup
                        ...
                        onChange={(event) =>
                            setReadingFrameOption(event.target.value as keyof typeof readingFrameOptions)
                        }
                    >
                ...
                <ThemeProvider theme={createAccentedTheme(ACCENT_COLOR)}>
                    ...
                    >
                        ...
                        <Stack direction="row" spacing={1} sx={{ minHeight: 0 }}>
                            <CustomDrawer variant="permanent" sx={{ mt: 2 }} role="tablist" aria-orientation="vertical">
                                <ListItem
                                    disablePadding
                                    role="tab"
