...
const WholePage = styled(
    ({
        ...
        }, [autoSelect, galleryListing, selection.append]);
                                ...
                                >
                                    <Stack sx={{ height: "100%" }}>
                                        ...
                                        <Box sx={{ borderBottom: theme.borders.card }}>
                                            <Alert icon={<BroadcastIcon fontSize="inherit" />} severity="info">
                                                Welcome to the <Link href={docLinks.gallery}>new Gallery!</Link> If you
                                                encounter any issues, please let us know by emailing{" "}
                                                <Link href="mailto:support@researchspace.com">support</Link> and using
                                                the{" "}
                                        ...
                                        <Box sx={{ display: "flex", minHeight: "0", flexGrow: 1 }} component="main">
                                            <Sidebar
                                                selectedSection={FetchingData.getSuccessValue(selectedSection).orElse(
                                                    null,
                                                )}
