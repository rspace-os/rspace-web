...
export default function ChemistryIcon(): React.ReactNode {
    ...
    return (
        <SvgIcon viewBox="0 0 40 40" className={classes.root}>
            <g>
                <polygon className={classes.element} points="28.2,5.7 11.8,5.7 3.5,20 11.8,34.3 28.2,34.3 36.5,20" />
                <g>
                    <line className={classes.element} x1="25.2" y1="11.2" x2="30.3" y2="20.1" />
                </g>
            </g>
        </SvgIcon>
    );
