...
describe("Grant User PI Role", () => {
    test(
        ...
        async () => {
            ...
            mockAxios.onGet("/vfpwd/ajax/checkVerificationPasswordNeeded").reply(200, { data: true });
    ...
    test(
        ...
        async () => {
            ...
            mockAxios.onGet("/vfpwd/ajax/checkVerificationPasswordNeeded").reply(200, { data: false });
