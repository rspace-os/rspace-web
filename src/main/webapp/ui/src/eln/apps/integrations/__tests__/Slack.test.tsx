...
describe("Slack", () => {
    ...
    beforeEach(() => {
        ...
        const channelDetails = {
            ...
            scope: "identify,commands,incoming-webhook,channels:history,groups:history,im:history,mpim:history,files:read,users:read,users:read.email",
            user_id: "U01A48677SP",
            team_id: "T1R89S3MG",
            enterprise_id: null,
        ...
        jest.spyOn(window, "setInterval").mockImplementation((f) => f() as unknown as NodeJS.Timeout);
    });
