                                            ...
                                            label={
                                                <>
                                                    ...
                                                    <Typography variant="body2" sx={{ fontSize: "0.825em" }}>
                                                        Only live links (that always point to the latest version of the
                                                        file) are inserted.
                                                    </Typography>
                                                </>
                                            }
                                        ...
                                        <FormControlLabel
                                            ...
                                            label={
                                                <>
                                                    ...
                                                    <Typography variant="body2" sx={{ fontSize: "0.825em" }}>
                                                        If the file is updated in Box after you made the link,
                                                        you&apos;ll still be able to download the original version. This
                                                        feature only works for premium Box accounts.
                                                    </Typography>
                                                </>
                                            }
                                        />
                                        <FormControlLabel
                                            ...
                                            label={
                                                <>
                                                    ...
                                                    <Typography variant="body2" sx={{ fontSize: "0.825em" }}>
                                                        This allows some links to be to live files and some to be to
                                                        older versions.
                                                    </Typography>
                                                </>
                                            }
