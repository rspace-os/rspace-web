            ...
            <IntegrationCard
                ...
                setupSection={
                    <ol>
                        <li>
                            {" "}
                            <b>Enable API access:</b> Generate your API key in My RSpace → My Profile.
                        </li>
                        <li>
                            <b>Configure Jupyter instance for all notebooks:</b> Follow the instructions in RSpace help
                            ...
                            Run the cell then <b>restart the kernel</b> and <b>refresh the browser </b> tab running
                            Jupyter.
                        </li>
                        <li>
                            <b>Configure notebook:</b> Follow the instructions in RSpace help docs to import the
                            ...
                            Run the cell, <b>restart the kernel</b> and then run the cell one more time{" "}
                            <b>without a kernel restart. Save the Notebook.</b>
                        </li>
                        <li>
                            <b>Run the code:</b>
                            <Typography variant="body2" sx={{ mt: 2, mb: 1 }}>
