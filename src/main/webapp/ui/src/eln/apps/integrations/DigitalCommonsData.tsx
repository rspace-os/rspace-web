            ...
            <IntegrationCard
                ...
                setupSection={
                    <>
                        <ol>
                            <li>
                                Click on Connect to authorise RSpace to access your Digital Commons Data and Mendeley
                                Data account.
                            </li>
                            <li>Enable the integration.</li>
                            <li>
                                Digital Commons Data / Mendeley Data will now be available as an option in the export
                                dialog.
                            </li>
                        </ol>
                        {connected ? (
