            ...
            <IntegrationCard
                ...
                setupSection={
                    <ol>
                        ...
                        <li>
                            When editing a document, click on the integration’s icon in the text editor toolbar to open
                            the chemical sketcher.
                        </li>
                        <li>
                            You can also drag and drop existing chemical structure files into a document text field, and
                            edit them.
                        </li>
                    </ol>
                }
