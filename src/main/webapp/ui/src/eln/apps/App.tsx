...
function App(): React.ReactNode {
    ...
    const [_lastDialogOpened, setLastDialogOpened] = useState<string | null>(null);
                                        ...
                                        <Grid container spacing={2} direction="column">
                                            <Grid item sx={{ mb: 1 }}>
                                                <Typography variant="body1">
                                                    RSpace provides integrations with various third-party apps that
                                                    enable extra features. Apps need to be enabled to work, and some
