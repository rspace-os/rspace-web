...
function CardListing({ mode, integrationStates }: CardListingArgs): React.ReactNode {
    ...
    const argosUpdate = React.useCallback(
        ...
        [update, integrationStates.ARGOS, integrationStates],
    );
    ...
    const boxUpdate = React.useCallback(
        ...
        [update, integrationStates.BOX, integrationStates],
    );
    ...
    const clustermarketUpdate = React.useCallback(
        ...
        [update, integrationStates.CLUSTERMARKET, integrationStates],
    );
    ...
    const dataverseUpdate = React.useCallback(
        ...
        [update, integrationStates.DATAVERSE, integrationStates],
    );
    ...
    const digitalCommonsDataUpdate = React.useCallback(
        ...
        [update, integrationStates.DIGITALCOMMONSDATA, integrationStates],
    );
    ...
    const dmponlineUpdate = React.useCallback(
        ...
        [update, integrationStates.DMPONLINE, integrationStates],
    );
    ...
    const dmptoolUpdate = React.useCallback(
        ...
        [update, integrationStates.DMPTOOL, integrationStates],
    );
    ...
    const dropboxUpdate = React.useCallback(
        ...
        [update, integrationStates.DROPBOX, integrationStates],
    );
    ...
    const dryadUpdate = React.useCallback(
        ...
        [update, integrationStates.DRYAD, integrationStates],
    );
    ...
    const egnyteUpdate = React.useCallback(
        ...
        [update, integrationStates.EGNYTE, integrationStates],
    );
    ...
    const evernoteUpdate = React.useCallback(
        ...
        [update, integrationStates.EVERNOTE, integrationStates],
    );
    ...
    const fieldmarkUpdate = React.useCallback(
        ...
        [update, integrationStates.FIELDMARK, integrationStates],
    );
    ...
    const figshareUpdate = React.useCallback(
        ...
        [update, integrationStates.FIGSHARE, integrationStates],
    );
    ...
    const galaxyUpdate = React.useCallback(
        ...
        [update, integrationStates.GALAXY, integrationStates],
    );
    ...
    const githubUpdate = React.useCallback(
        ...
        [update, integrationStates.GITHUB, integrationStates],
    );
    ...
    const googleDriveUpdate = React.useCallback(
        ...
        [update, integrationStates.GOOGLEDRIVE, integrationStates],
    );
    ...
    const joveUpdate = React.useCallback(
        ...
        [update, integrationStates.JOVE, integrationStates],
    );
    ...
    const chemistryUpdate = React.useCallback(
        ...
        [update, integrationStates.CHEMISTRY, integrationStates],
    );
    ...
    const nextCloudUpdate = React.useCallback(
        ...
        [update, integrationStates.NEXTCLOUD, integrationStates],
    );
    ...
    const omeroUpdate = React.useCallback(
        ...
        [update, integrationStates.OMERO, integrationStates],
    );
    ...
    const onedriveUpdate = React.useCallback(
        ...
        [update, integrationStates.ONEDRIVE, integrationStates],
    );
    ...
    const ownCloudUpdate = React.useCallback(
        ...
        [update, integrationStates.OWNCLOUD, integrationStates],
    );
    ...
    const protocolsioUpdate = React.useCallback(
        ...
        [update, integrationStates.PROTOCOLS_IO, integrationStates],
    );
    ...
    const pyratUpdate = React.useCallback(
        ...
        [update, integrationStates.PYRAT, integrationStates],
    );
    ...
    const raidUpdate = React.useCallback(
        ...
        [update, integrationStates.RAID, integrationStates],
    );
    ...
    const slackUpdate = React.useCallback(
        ...
        [update, integrationStates.SLACK, integrationStates],
    );
    ...
    const teamsUpdate = React.useCallback(
        ...
        [update, integrationStates.MSTEAMS, integrationStates],
    );
    ...
    const zenodoUpdate = React.useCallback(
        ...
        [update, integrationStates.ZENODO, integrationStates],
    );
    ...
    return (
        <Grid container spacing={3} alignItems="stretch">
            ...
            {integrationStates.ASCENSCIA.mode === mode && (
                <Ascenscia integrationState={integrationStates.ASCENSCIA} update={ascensciaUpdate} />
            )}
            ...
            {integrationStates.RAID.mode === mode && (
                <RaIDIntergrationCard integrationState={integrationStates.RAID} update={raidUpdate} />
            )}
