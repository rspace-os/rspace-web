...
export const WorkFlowIcon = createSvgIcon(<svg id="Layer_1" xmlns="http://www.w3.org/2000/svg"
      ...
      <line x1="6.443" y1="10" x2="17.276" y2="10" fill="#fff" stroke="#fff" strokeMiterlimit="10"
            strokeWidth="1.4"/>
      <path d="M4.932,3.535c3.136,0,5.677,2.894,5.677,6.465s-2.542,6.465-5.677,6.465" fill="none"
            stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.4"/>
      <polyline points="15.073 7.867 17.206 10 15.073 12.133" fill="none" stroke="#fff"
