...
type Editor = {
  ui: {
    registry: {
      addMenuItem: (menuItemIdentifier: string, options: { text: string; icon: string; onAction: () => void }) => void;
      addButton: (buttonIdentifier: string, options: { tooltip: string; icon: string; onAction: () => void }) => void;
    };
  };
