                    ...
                    <FormControlLabel
                        control={
                            <Checkbox
                                ...
                                onChange={(event) => handleChange(event.target.value, (!state.showEnzymes).toString())}
                                value="showEnzymes"
                                color="primary"
                            />
                        }
                    ...
                    <FormControlLabel
                        control={
                            <Checkbox
                                ...
                                onChange={(event) => handleChange(event.target.value, (!state.showORFs).toString())}
                                value="showORFs"
                                color="primary"
                            />
                        }
