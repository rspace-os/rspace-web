...
class Shortcuts extends React.Component {
    ...
    applyCurrentConfigActions = () => {
        let saved_config_actions = JSON.parse(localStorage.getItem("custom_shortcuts_actions"));

        // backward compatibility
        if (!saved_config_actions) {
            saved_config_actions = JSON.parse(localStorage.getItem("custom_shortcuts"));
        }
    ...
    applyCurrentConfigSymbols = () => {
        const saved_config_symbols = JSON.parse(localStorage.getItem("custom_shortcuts_symbols"));
                    ...
                    >
                        ...
                        {this.state.tab === 0 && this.state.instructions && (
                            <ul>
                                ...
                                <li>
                                    On your keyboard, press the key combination you would like to use for that command.
                                </li>
                                <li>Click on 'Save'.</li>
                            </ul>
                        )}
                        {this.state.tab === 1 && this.state.instructions && (
                            <ul>
                                <li>
                                    All configurable symbols are divided into sections. Click on a section to find the
                                    desired symbol. For example, Greek characters are in the 'Extended Latin' section.
                                </li>
                                ...
                                <li>
                                    On your keyboard, press the key combination you would like to use for that symbol.
                                </li>
                                <li>Click on 'Save'.</li>
                            </ul>
                        )}
                        {this.state.instructions && (
                            <p>
                                ...
                                of reserved shortcuts already used by the editor. Please note that single keys, or Shift
                                + single key, are not accepted, as these shortcuts will interfere with editing. Good
                                choices for shortcuts are Ctrl + Shift + number/letter, or Alt + Shift + number/letter.
                            </p>
                        )}
                    </Alert>
                </AlertWrapper>
