...
document.addEventListener("DOMContentLoaded", () => {
    ...
    root.render(<Clustermarket clustermarket_web_url={parent.tinymce.activeEditor.settings.clustermarket_web_url} />);
});
...
function createTinyMceTable() {
    ...
    stableSort(getSelectedBookings(), getSorting(getOrder(), getOrderBy())).forEach((booking) => {
