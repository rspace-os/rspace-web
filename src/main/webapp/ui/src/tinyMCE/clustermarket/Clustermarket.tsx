...
function Clustermarket({
    ...
    function handleRequestError(error: { message: string; response: { status: number; data: string } | null }) {
    ...
    }, [selectedBookingIds, bookingType, bookings.filter, equipment.filter]);
