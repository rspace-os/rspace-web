...
describe("Has defaultOrderBy ", () => {
    ...
    it("returns Order By value in localStorage", () => {
        localStorageMock.getItem = jest.fn().mockImplementationOnce(() => '"duration"');
...
describe("Has defaultOrder ", () => {
    ...
    it("returns Order value in localStorage", () => {
        localStorageMock.getItem = jest.fn().mockImplementationOnce(() => Order.desc);
...
describe("Renders page with booking data ", () => {
    ...
    it("bookings are ordered by start date, ascending", async () => {
        ...
        expect(screen.getByTestId("start_time0")).toHaveTextContent("2022-01-28 07:30:00");

        expect(screen.getByTestId("start_time1")).toHaveTextContent("2022-02-28 06:30:00");

        expect(screen.getByTestId("start_time2")).toHaveTextContent("2022-02-28 06:31:00");

        expect(screen.getByTestId("start_time3")).toHaveTextContent("2022-02-28 07:30:00");
    });
