...
describe("Renders page with booking data", () => {
  test("displays booking table headers", async () => {
    getWrapper();
    await findFirstByText("apps:tinyMce.clustermarket.columns.bookingId");
  });

  test("displays booking type radio and maintenance checkbox", async () => {
    getWrapper();
    await findFirstByText("apps:tinyMce.clustermarket.bookingTypes.booked");
    await findFirstByText("apps:tinyMce.clustermarket.bookingTypes.all");
    await findFirstByText("apps:tinyMce.clustermarket.bookingTypes.equipment");
    await findFirstByText("apps:tinyMce.clustermarket.maintenanceOnly");
  });
