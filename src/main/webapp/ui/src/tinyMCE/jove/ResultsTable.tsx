...
import type { Article, ArticleId } from "./JoveClient";
...
export default function ResultsTable({
    ...
    function onRowClick(_event: unknown, id: ArticleId) {
    ...
    function handleRequestSort(_event: unknown, property: "" | "thumbnail" | "title" | "section") {
    ...
    }, [order, orderBy, searchResults, setSearchResults]);
                                ...
                                >
                                    ...
                                    {visibleHeaderCells.map((cell, i) => (
                                        <TableCell key={`${cell.id}${i}`} data-testid={`${cell.id}${index}`}>
                                            {cell.id === "title" && article[cell.id].replace(/<[^>]*>?/gm, "")}
