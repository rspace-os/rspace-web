        ...
        <Alert severity="error">
            ...
            {errorReason === ErrorReason.NetworkError && (
                <>
                    ...
                    setting up the Jove integration, open developer tools and have a look at the console and/or the
                    network tab to find out what the issue is.
                </>
            )}
            ...
            {errorReason === ErrorReason.NotFound && <>Unable to retrieve any relevant results.</>}
