        ...
        return (
            <>
                <TableContainer className={classes.tableContainer} ref={ref as any}>
                    <Table aria-label="item search results" sx={{ display: "table", overflowX: "auto" }}>
                        <EnhancedTableHead
                        ...
                        <TableBody sx={{ width: "100%" }}>
                            {omeroSort(results, order, orderBy)
                                ...
                                .filter((item) => item.type !== "well sample" && (item.type as any) !== "well")
                                .map((item, index) => {
                                                ...
                                                sx={
                                                    item.type === "dataset" || item.type === "plate"
                                                        ...
                                                        : item.type === "project" || item.type === "screen"
                                                          ...
                                                          : item.type === "image" || (item.type as any) === "well"
                                                            ? {
                                                ...
                                                >
                                                    {cell.id === "description" && item.imageGridDetails ? (
                                                        ...
                                                        <dl>
                                                            ...
                                                            {item.displayType ? (
                                                                <dt className={classes.boldText}>{item.displayType}</dt>
                                                            ) : (
                                                                <dt className={classes.boldText}>{item.type}</dt>
                                                            )}
                                                            <dt>
                                                                {" "}
                                                                {item.fetched ? (
                                                                    ...
                                                                    <a
                                                                        ...
                                                                        href={`#${item.type}_name_display_${item.id}`}
                                                                        onClick={() => {
                                                                ...
                                                                {item.gridShown ? (
                                                                    ...
                                                                    >
                                                                        hide image grid{" "}
                                                                        {item.samplesUrls && item.samplesUrls.length > 1
                                                            ...
                                                            <dt id={`${item.type}_fetch_children_${item.id}`}>
                                                                {" "}
