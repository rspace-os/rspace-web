...
export default function main(props) {
    ...
    function addUsers() {
        const selected = usersRight.concat(props.users.filter((u) => selectedLeft.includes(u.username)));
    ...
    function removeUsers() {
        setUsersLeft(props.users.filter((u) => selectedRight.includes(u.username)).concat(usersLeft));
    ...
    }, [props.users, usersLeft.length, usersRight.length]);
