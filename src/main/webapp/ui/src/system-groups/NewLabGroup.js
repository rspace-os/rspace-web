...
export default function NewLabGroup() {
    ...
    function submit() {
        ...
        params.groupOwners = values.groupOwners.length ? values.groupOwners.map((m) => m.username) : values.groupOwners;
        ...
        if (values.groupType === LAB_GROUP) {
            ...
            params.memberString = params.memberString.concat(
                ...params.groupOwners.filter((owner) => !params.memberString.includes(owner)),
            );
        }
                ...
                <form noValidate autoComplete="off">
                    <Grid container>
                        ...
                        <Grid item xs={12}>
                            ...
                            <Select value={values.groupType} onChange={updateSelectedDropdown("groupType")}>
                            ...
                            {values.groupType && (
                                <Grid container>
                                    <Typography
                                        ...
                                        color="inherit"
                                    >
                                        Select group members <span style={{ color: "grey" }}>(optional)</span>
                                    </Typography>
                                    <UserSelect
                                        users={users}
                                        labelLeft="Available users"
