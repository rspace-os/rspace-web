...
function ExportRepo({
    ...
    const [state] = useState(
        observable({
            inputValidations: STANDARD_VALIDATIONS as typeof STANDARD_VALIDATIONS | typeof DRYAD_VALIDATIONS,
            submitAttempt: false,
    ...
    useEffect(() => {
        validator.setValidFunc(() => {
            ...
            if (repo.repoName === "app.dryad") {
                ...
                if (Object.keys(state.otherProperties.funder).length !== 0) validations.crossrefFunder = true;
            }
    ...
    }, [repoList[state.repoChoice], state, validator.setValidFunc]);
