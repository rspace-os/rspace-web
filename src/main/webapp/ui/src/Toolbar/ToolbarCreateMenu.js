        ...
        <CreateMenuWrapper>
            ...
            >
                ...
                {dynamicItems.map((entry) => (
                    ...
                    >
                        <img src={entry.iconURL} style={{ paddingRight: "7px", width: "22px", marginLeft: "-5px" }} />
                        {entry.name}
                ...
                {props.asposeEnabled && (
                    <MenuItem id="createFromWord" data-test-id="create-btn-word">
                        <FontAwesomeIcon icon={faFileWord} style={{ paddingRight: "10px" }} />
                        From Word
                    </MenuItem>
                )}
                {props.evernoteEnabled && (
                    <MenuItem id="createFromEvernote" data-test-id="create-btn-evernote">
                        <FontAwesomeIcon icon={faEvernote} style={{ paddingRight: "10px" }} />
                        From Evernote
                    </MenuItem>
                )}
                {props.pioEnabled && (
