...
class AdvancedSearch extends React.Component {
    ...
    validateQueries = () => {
        ...
        this.state.queries.map((query, idx) => {
            const isSimple = ["fullText", "name", "form", "template", "attachment"].includes(query.filter);
            ...
            <QueryRow key={idx}>
                <td className="search-type">
                    <Select
                        ...
                        style={{
                            paddingTop: ["created", "lastModified"].includes(query.filter) ? "16px" : "0px",
                        }}
                    >
                ...
                <td className="search-term">
                    {["fullText", "name", "form", "template", "attachment"].includes(query.filter) && (
                        <Searchbox
                            idx={idx}
                            query={query}
                    ...
                    {["owner"].includes(query.filter) && (
                        <UserSelect
                            ...
                            selected={query.term}
                            advanced={true}
                            updateSelected={(s, l) => this.handleSelectAutocomplete(s, l, idx)}
            ...
            <CardWrapper>
                <Card style={{ overflow: "visible" }}>
                    ...
                    <CardContent>
                        ...
                        {this.state.queries.length > 1 && (
                            <RadioGroup value={this.state.fulfillAll} onChange={this.handleCheck} margin="dense">
                                <FormControlLabel
                                    value="true"
                                    control={
                                        <Radio
                                    ...
                                    label={
                                        <div>
                                            ...
                                            {this.state.queries.findIndex((q) => q.filter === "records") !== -1 && (
