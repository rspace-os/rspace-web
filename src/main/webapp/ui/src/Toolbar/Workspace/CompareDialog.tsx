...
function CompareDialog(): React.ReactNode {
    ...
    }, [addAlert, analytics.trackEvent, getToken]);
                ...
                <Grid container direction="column" spacing={2}>
                    <Grid item>
                        <Typography variant="body2">
                            Select the documents you want to combine into a single CSV file. Documents with identical
                            structures will be automatically aligned, including form data and content. If documents have
                            different structures, additional columns will be created to accommodate all information.
                        </Typography>
                    </Grid>
