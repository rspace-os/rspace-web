...
export default function GalleryToolbar(): React.ReactNode {
    ...
    const Content = (
        <>
            <ButtonWrapper>
                <Button data-test-id="choose-gallery-btn" onClick={(e) => openGalleryMenu(e)} variant="outlined">
                    Choose Gallery
                </Button>
            </ButtonWrapper>
            <ButtonWrapper>
                <Button data-test-id="imprt-btn" onClick={(e) => openImportMenu(e)} variant="outlined">
                    Import
                </Button>
            </ButtonWrapper>
            <h1>{domContainer?.getAttribute("data-net-filestores-enabled") === "true"}</h1>
            <Menu
                anchorOrigin={{
                    vertical: "bottom",
                    horizontal: "left",
            ...
            >
                <MenuItem className="imageButton" data-test-id="gallery-image-btn" onClick={closeGalleryMenu}>
                    Image
                </MenuItem>
                <MenuItem className="audioButton" data-test-id="gallery-audio-btn" onClick={closeGalleryMenu}>
                    Audio
                </MenuItem>
                <MenuItem className="videoButton" data-test-id="gallery-video-btn" onClick={closeGalleryMenu}>
                    Video
                </MenuItem>
                <MenuItem className="documentButton" data-test-id="gallery-docs-btn" onClick={closeGalleryMenu}>
                    Docs
                </MenuItem>
                <MenuItem className="chemistryButton" data-test-id="gallery-misc-btn" onClick={closeGalleryMenu}>
                    Chemistry
                </MenuItem>

                <MenuItem className="snippetButton" data-test-id="gallery-snippets-btn" onClick={closeGalleryMenu}>
                    Snippets
                </MenuItem>
                <MenuItem className="miscButton" data-test-id="gallery-misc-btn" onClick={closeGalleryMenu}>
                    Misc
                </MenuItem>
                <MenuItem className="exportButton" data-test-id="gallery-exports-btn" onClick={closeGalleryMenu}>
                    Exports
                </MenuItem>
                {domContainer?.getAttribute("data-net-filestores-enabled") === "true" && (
                    <MenuItem className="netButton" data-test-id="gallery-filestores-btn" onClick={closeGalleryMenu}>
                        Filestores
                    </MenuItem>
                )}
                {domContainer?.getAttribute("data-dmp-enabled") === "true" && (
                    <MenuItem className="dmpButton" data-test-id="gallery-dmp-btn" onClick={closeGalleryMenu}>
                        DMPs
                    </MenuItem>
                )}
            </Menu>
            ...
            >
                <MenuItem id="fromLocalComputer" data-test-id="gallery-import-local" onClick={closeImportMenu}>
                    File
                </MenuItem>
