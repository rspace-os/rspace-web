        ...
        fc.assert(
            fc.property(
                ...
                <T>([as, bs, cs, booleanFunction]: [T[], T[], T[], (a: T, b: T) => T]) => {
                    expect(
                        ArrayUtils.zipWith(as, ArrayUtils.zipWith(bs, cs, booleanFunction), booleanFunction),
                    ).toEqual(ArrayUtils.zipWith(ArrayUtils.zipWith(as, bs, booleanFunction), cs, booleanFunction));
                },
            ),
        );
    });
