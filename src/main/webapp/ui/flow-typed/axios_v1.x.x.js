/**
 * Note that this file has been forked from the definition provided by flow-typed.
 *
 * Changes include:
 *   - Changing the type of `params` from a plain object of strings, to a
 *     URLSearchParams thereby ensuring that all parameters are URL encoded.
 */
