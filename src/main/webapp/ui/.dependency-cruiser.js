    ...
    forbidden: [
        {
            ...
            from: {},
            to: {
                licenseNot: ["MIT", "BSD", "Apache", "Hippocratic", "ISC", "MPL", "GPL"],
                pathNot: [
...
*/
...

        {
            ...
            from: {
                path: "^(src)",
                pathNot: "__tests__|.(spec|test).(js|mjs|cjs|ts|tsx|ls|coffee|litcoffee|coffee.md)$",
            },
            to: {
...

        {
            ...
            to: {
                pathNot: "src/util|babel|jest-dom|fast-check|mobx|react|@fortawesome|@mui",
            },
        },
