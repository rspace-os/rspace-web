...
tinymce.PluginManager.add('onedrive', function (editor, url) {
	...
	// Configuration needed by the OneDrive file picker, supplied via tinymce setup
	// (see tinymce5_configuration.js). Exposed as globals so openOneDriveFilePicker
	// can read them, mirroring the Gallery's mediaGalleryManager.js.
	window.oneDriveClientId = editor.settings.onedrive_client_id;
	window.oneDriveRedirect = editor.settings.onedrive_redirect;
