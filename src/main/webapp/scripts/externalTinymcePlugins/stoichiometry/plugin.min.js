      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          if (response.data) {
            ...
            html += '<h3>Stoichiometry Information</h3>';
            ...
            if (stoichiometry.molecules && stoichiometry.molecules.length > 0) {
              ...
              html += '<tr><th>ID</th><th>RS Chem Element ID</th><th>Role</th><th>Formula</th><th>Name</th><th>SMILES</th><th>Coefficient</th><th>Molecular Weight</th><th>Mass</th><th>Moles</th><th>Expected Amount</th><th>Actual Amount</th><th>Actual Yield</th><th>Notes</th></tr>';
              
              stoichiometry.molecules.forEach(function(molecule) {
                html += '<tr>';
                html += '<td>' + (molecule.id || '') + '</td>';
                html += '<td>' + (molecule.rsChemElement.id || '') + '</td>';
                html += '<td>' + (molecule.role || '') + '</td>';
                html += '<td>' + (molecule.formula || '') + '</td>';
                html += '<td>' + (molecule.name || '') + '</td>';
                html += '<td>' + (molecule.smiles || '') + '</td>';
                html += '<td>' + (molecule.coefficient || '') + '</td>';
                html += '<td>' + (molecule.molecularWeight || '') + '</td>';
                html += '<td>' + (molecule.mass || '') + '</td>';
                html += '<td>' + (molecule.moles || '') + '</td>';
                html += '<td>' + (molecule.expectedAmount || '') + '</td>';
                html += '<td>' + (molecule.actualAmount || '') + '</td>';
                html += '<td>' + (molecule.actualYield || '') + '</td>';
                html += '<td>' + (molecule.notes || '') + '</td>';
                html += '</tr>';
              });
          ...
          if (response.data) {
            ...
            if (stoichiometry.molecules && stoichiometry.molecules.length > 0) {
              ...
              stoichiometry.molecules.forEach(function(molecule) {
                html += '<tr>';
                html += '<td>' + (molecule.id || '') + '</td>';
                html += '<td>' + (molecule.rsChemElementId || '') + '</td>';
                html += '<td>' + (molecule.role || '') + '</td>';
                html += '<td>' + (molecule.formula || '') + '</td>';
                html += '<td>' + (molecule.name || '') + '</td>';
                html += '<td>' + (molecule.smiles || '') + '</td>';
