...
function addKetcherChemContextToolbar(editor){
	...
	editor.ui.registry.addContextToolbar('chemicalFileViewableKetcher', {
		...
		items: 'attachmentinfopopup attachmentdownload | resizeImage | ketcherViewable | stiochiometry',
		position: 'node',
		scope: 'node'
	});
	editor.ui.registry.addContextToolbar('chemicalElementEditableKetcher', {
		...
		items: 'downloadImage | resizeImage | ketcherEditable | stiochiometry',
		position: 'node',
		scope: 'node'
	});
	...
	editor.ui.registry.addButton('stiochiometry', {
    tooltip: 'View stiochiometry',
    icon: 'stiochiometry',
    onAction: function () { editor.execCommand("cmdStiochiometry"); },
  });
}
