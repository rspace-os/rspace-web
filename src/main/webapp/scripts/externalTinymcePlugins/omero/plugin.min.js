tinymce.PluginManager.add('omero', function (editor, url) {
    ...
    editor.addCommand("cmdOmero", function () {
        // The dialog builds the table and sends it up with each selection change,
        // so inserting into the editor stays here rather than in the React dialog.
        let tableHtml = null;
        editor.windowManager.openUrl({
            ...
            onMessage(dialogApi, details) {
                if ("tableHtml" in details) {
                    tableHtml = details.tableHtml;
                }
