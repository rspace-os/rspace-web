...
<div id="auditUser" class="auditIt">
	<h3>
		<spring:message code="audit.scopeHeading.user"/>
	</h3>
	<h4>
		<spring:message code="audit.activity.filter.lead"/>
		...
		by <a href="#" id="oid" class="addRow"><spring:message code="inventory:formSections.identifiers"/></a>
		and by <a href="#" id="dates" class="addRow"><spring:message code="audit.date.label"/></a>
	</h4>
...
<div id="auditPI" class="auditIt">
	<h3>
		<spring:message code="audit.scopeHeading.group"/>
  </h3>
  <h4>
		<spring:message code="audit.activity.filter.lead"/>
		by <a href="#" id="domains" class="addRow"><spring:message code="audit.domains.label"/></a>,
		...
		and by <a href="#" id="users" class="addRow"><spring:message code="system:usersPage.title"/></a>
	</h4>
	<div class="auditRow"></div>
</div>
</shiro:hasRole>
...
<div id="auditAdmin" class="auditIt">
	<h3>
		<spring:message code="audit.scopeHeading.community"/>
  </h3>
  <h4>
		<spring:message code="audit.activity.filter.lead"/>
		by <a href="#" id="domains" class="addRow"><spring:message code="audit.domains.label"/></a>,
		...
		by <a href="#" id="oid" class="addRow"><spring:message code="inventory:formSections.identifiers"/></a>,
		by <a href="#" id="dates" class="addRow"><spring:message code="audit.date.label"/></a>,
		by <a href="#" id="users" class="addRow"><spring:message code="system:usersPage.title"/></a>
		and by <a href="#" id="groups" class="addRow"><spring:message code="common:profile.groups.title"/></a>
	</h4>
	<div class="auditRow"></div>
</div>
</shiro:hasRole>
...
<div id="auditSysAdmin" class="auditIt">
  <h3>
    <spring:message code="audit.scopeHeading.global"/>
  </h3>
  <h4>
		<spring:message code="audit.activity.filter.lead"/>
		by <a href="#" id="domains" class="addRow"><spring:message code="audit.domains.label"/></a>,
		...
		by <a href="#" id="dates" class="addRow"><spring:message code="audit.date.label"/></a>,
		by <a href="#" id="users" class="addRow"><spring:message code="system:usersPage.title"/></a>,
		by <a href="#" id="groups" class="addRow"><spring:message code="common:profile.groups.title"/></a>
		and by <a href="#" id="communities" class="addRow"><spring:message code="audit.communities.label"/></a>
   </h4>
   <div class="auditRow"></div>
</div>
</shiro:hasRole>
