...
<div class="container">
    ...
    <c:choose>
		<c:when test="${not empty principalEmail}">
			<h4>
				<spring:message code="group.created.success.nominationSummary">
					<spring:argument value="${groupName}"/>
					<spring:argument value="${principalEmail}"/>
					<spring:argument value="${not empty emails}"/>
				</spring:message>
			</h4>
		</c:when>
		<c:otherwise>
			<h4>
				<spring:message code="group.created.success.currentPiSummary">
					<spring:argument value="${groupName}"/>
					<spring:argument value="${not empty emails}"/>
				</spring:message>
			</h4>
