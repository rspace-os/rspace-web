...
<div id="communityProps">
  <div id="propertyView" >
    <h2>
      <fmt:formatDate type="date" value="${community.creationDate}" var="communityCreationDate"/>
      <spring:message code="community.directoryHeading">
        <spring:argument value='<span id="displayName" class="editableProperty">${community.displayName}</span>'/>
        <spring:argument value="${communityCreationDate}"/>
      </spring:message>
    </h2>
