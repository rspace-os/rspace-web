...
<head>
    ...
    <script src="<rst:assetUrl value='/scripts/pages/connect/msoffice/officeView.js'/>"></script>
    ...
    <link rel="stylesheet" href="<rst:assetUrl value='/styles/pages/connect/msoffice/officeView.css'/>" />
