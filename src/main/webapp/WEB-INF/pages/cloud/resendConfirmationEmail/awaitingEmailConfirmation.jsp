...
<div class="container" style="max-width:960px;padding:0 5% 0 5%;">
    ...
    <div style="max-width:450px;margin: 0 auto;margin-top:30px;text-align:center;">
		<spring:message code="resendEmail.awaitingEmailConfirmation.activationInstructions" />
		<br />
		<br />
		<spring:message code="resendEmail.awaitingEmailConfirmation.supportInstructions" />
