            ...
            <td><c:choose>
                <c:when test="${not empty groupSharing.targetFolder}">
                  <div style="margin: 4px 2px;">
                    <spring:message code="groups.sharing.sharedForEditInto">
                      <spring:argument value="<a href='/globalId/${groupSharing.targetFolder.globalIdentifier}'>${groupSharing.targetFolder.globalIdentifier}</a>"/>
                    </spring:message>
                  </div>
                </c:when>
                <c:otherwise>
