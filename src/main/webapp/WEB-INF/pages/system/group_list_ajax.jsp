...
<tr  class="table_headRow">
  <th width="5%"><spring:message code="system.groupList.columns.options"/></th>
  ...
  <th width="5%">
   <spring:message code="system.groupList.columns.sizeLinkLabel" var="groupListSizeLinkLabel"/>
   <spring:message code="system.groupList.columns.size">
