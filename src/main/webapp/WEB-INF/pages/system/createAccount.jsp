  ...
  <div id="pageTopButtons">
    <div id="selectAccountToCreateSection">
      <a href="#" class="pageTopButton" id="newUserAccountButton"
        ...
        <spring:message code="system:usersPage.roleLabels.user" /></a>
      <a href="#" class="pageTopButton" id="newPiAccountButton"
        ...
        <spring:message code="system:usersPage.roleLabels.pi" /></a>
    ...
    <table width="100%">
      <tr>
        <td width="150px" class="likeHeaders"><span style="font-size: 1.3em;line-height:1.3em;">
            <spring:message code="system:usersPage.roleLabels.user" /></span></td>
        <td>
      ...
      <tr>
        <td width="150px" class="likeHeaders"><span style="font-size: 1.3em;line-height:1.3em;">
            <spring:message code="system:usersPage.roleLabels.pi" /></span></td>
        <td>
...
<div id="batchUploadUserDlg" style="display: none; margin:10px">
  <rst:hasDeploymentProperty name="cloud" value="true">
    <spring:message code="system.batchRegistration.upload.helpTextCloud"/>
  </rst:hasDeploymentProperty>
  <rst:hasDeploymentProperty name="cloud" value="false">
    <rst:hasDeploymentProperty name="standalone" value="true">
      <spring:message code="system.batchRegistration.upload.helpTextStandalone"/>
    </rst:hasDeploymentProperty>
    <rst:hasDeploymentProperty name="standalone" value="false">
      <spring:message code="system.batchRegistration.upload.helpTextSso"/>
    </rst:hasDeploymentProperty>
  </rst:hasDeploymentProperty>

  <br /><br />
  <spring:message code="system.batchRegistration.helpText.exampleCsvLabel" var="createAccountExampleCsvLabel"/>
  <spring:message code="system.batchRegistration.helpText.exampleCsvIntro">
    <spring:argument value='<a href="/resources/batch_registration_example.csv" style="outline:none; color: #1465b7">${createAccountExampleCsvLabel}</a>'/>
  </spring:message>

  <rst:hasDeploymentProperty name="ldapEnabled" value="true">
    <br /><br />
    <spring:message code="system.batchRegistration.helpText.ldapCsv"/>
  </rst:hasDeploymentProperty>
