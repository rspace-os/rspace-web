...
VALUES
  (910100001, 'sysadmin1', NOW(), NOW(), 'sysadmin1', b'0', 'Dev booking instrument 01',
   'Fresh dev booking seed', 1, 0, -12, 'Instrument', b'1', 0, UNIX_TIMESTAMP() * 1000,
   UNIX_TIMESTAMP() * 1000),
  (910100002, 'sysadmin1', NOW(), NOW(), 'sysadmin1', b'0', 'Dev booking instrument 02',
   'Fresh dev booking seed', 1, 0, -12, 'Instrument', b'1', 0, UNIX_TIMESTAMP() * 1000,
   UNIX_TIMESTAMP() * 1000),
  (910100003, 'sysadmin1', NOW(), NOW(), 'sysadmin1', b'0', 'Dev booking instrument 03',
   'Fresh dev booking seed', 1, 0, -12, 'Instrument', b'1', 0, UNIX_TIMESTAMP() * 1000,
   UNIX_TIMESTAMP() * 1000),
  (910100004, 'sysadmin1', NOW(), NOW(), 'sysadmin1', b'0', 'Dev booking instrument 04',
   'Fresh dev booking seed', 1, 0, -12, 'Instrument', b'1', 0, UNIX_TIMESTAMP() * 1000,
   UNIX_TIMESTAMP() * 1000),
  (910100005, 'sysadmin1', NOW(), NOW(), 'sysadmin1', b'0', 'Dev booking instrument 05',
   'Fresh dev booking seed', 1, 0, -12, 'Instrument', b'1', 0, UNIX_TIMESTAMP() * 1000,
   UNIX_TIMESTAMP() * 1000),
  (910100006, 'sysadmin1', NOW(), NOW(), 'sysadmin1', b'0', 'Dev booking instrument 06',
   'Fresh dev booking seed', 1, 0, -12, 'Instrument', b'1', 0, UNIX_TIMESTAMP() * 1000,
   UNIX_TIMESTAMP() * 1000),
  (910100007, 'sysadmin1', NOW(), NOW(), 'sysadmin1', b'0', 'Dev booking instrument 07',
   'Fresh dev booking seed', 1, 0, -12, 'Instrument', b'1', 0, UNIX_TIMESTAMP() * 1000,
   UNIX_TIMESTAMP() * 1000),
  (910100008, 'sysadmin1', NOW(), NOW(), 'sysadmin1', b'0', 'Dev booking instrument 08',
   'Fresh dev booking seed', 1, 0, -12, 'Instrument', b'1', 0, UNIX_TIMESTAMP() * 1000,
   UNIX_TIMESTAMP() * 1000),
  (910100009, 'sysadmin1', NOW(), NOW(), 'sysadmin1', b'0', 'Dev booking instrument 09 (no configuration)',
   'Fresh dev booking seed', 1, 0, -12, 'Instrument', b'1', 0, UNIX_TIMESTAMP() * 1000,
   UNIX_TIMESTAMP() * 1000);
