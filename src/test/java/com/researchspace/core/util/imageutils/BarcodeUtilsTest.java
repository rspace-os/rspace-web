...
public class BarcodeUtilsTest {
  ...
  public void testBarcodeGeneration() throws WriterException, IOException {
    ...
    BufferedImage longContentBarcode =
        BarcodeUtils.generateBarcodeImage("SS123456789012345678901234567890", null, null);
  ...
  public void testQRCodeGeneration() throws WriterException, IOException {
    ...
    BufferedImage longContentQR =
        BarcodeUtils.generateQRCodeImage("SS123456789012345678901234567890", null, null);
