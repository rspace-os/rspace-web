...
public class RandomTextFileGenerator {
  ...
  /**
   * Generates <code>numFiles</code> files of <code>linesPerFile</code> lines of random text, each
   * with 15 words perline, based on naturally occurring word frequency. In addition, creates a file
   * called textAttachmentstoLoad.csv which lists file names and 2 suitable search terms that appear
   * in the file
   *
