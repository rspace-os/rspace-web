...
class ChemistryClientTest {
  ...
  public void whenConvertRequestThrowsException_thenThrowChemistryException() {
    ...
    String expectedErrorMsg = messages.getMessage("errors.chemistry.convertFailed");
    assertEquals(expectedErrorMsg, resolve(exception));
  }
  ...
  public void whenExtractionResponseHasErrorStatus_thenThrowChemistryClientException() {
    ...
    assertEquals(messages.getMessage("errors.chemistry.requestRejected"), resolve(exception));
  }
  ...
  public void whenExtractRequestThrowsException_thenThrowChemistryException() {
    ...
    ChemistryClientException exception =
        assertThrows(ChemistryClientException.class, () -> chemistryClient.extract("CCC"));
    assertEquals(messages.getMessage("errors.chemistry.serviceCallFailed"), resolve(exception));
  }
  ...
  void whenImageExportThrowsException_thenThrowChemistryException() {
    ...
    String expectedErrorMsg = messages.getMessage("errors.chemistry.imageExportFailed");
    assertEquals(expectedErrorMsg, resolve(exception));
  }
  ...
  public void whenSaveRequestThrowsException_thenThrowChemistryException() {
    ...
    String expectedErrorMsg = messages.getMessage("errors.chemistry.saveFailed");
    assertEquals(expectedErrorMsg, resolve(exception));
  }
  ...
  public void whenSearchThrowsException_thenThrowChemistryException() {
    ...
    String expectedErrorMsg = messages.getMessage("errors.chemistry.searchFailed");
    assertEquals(expectedErrorMsg, resolve(exception));
  }
  ...
  public void whenFastSearchIndexingThrowsException_thenUseIndexingMessage() {
    ...
    assertEquals(messages.getMessage("errors.chemistry.indexingFailed"), resolve(exception));
  }
