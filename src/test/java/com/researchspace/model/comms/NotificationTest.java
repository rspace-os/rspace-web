...
public class NotificationTest {
  ...
  public void testArchiveExportNotificationAndItsData() {
    ...
    assertEquals(
        "{\"downloadLink\":\"https://testArchiveLink\",\"nfsLinksIncluded\":false}",
        archiveNot.getNotificationData());

    ArchiveExportNotificationData retrievedDataWithLink =
        (ArchiveExportNotificationData) archiveNot.getNotificationDataObject();
