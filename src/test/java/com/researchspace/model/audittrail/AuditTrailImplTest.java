...
public class AuditTrailImplTest {
  ...
  @Captor ArgumentCaptor<Iterable<HistoricData>> historicDataCaptor;
  ...
  public void testPersonConverter() {
    ...
    assertEquals(
        sysadminOperatingAs.getUniqueName() + "->" + subject.getUniqueName(), data.getSubject());
    assertEquals(
        sysadminOperatingAs.getFullName() + " -> " + subject.getFullName(), data.getFullName());
  }
}
