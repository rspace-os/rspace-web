...
public class UserConnectionTest {
  ...
  public void encryptDecryptInvariants() {
    ...
    assertEncryption(
        someConnection, expectedEncryptedAccess, expectedEncryptedRefresh, expectedEncryptedSecret);
  ...
  private void assertEncryption(
      UserConnection someConnection,
      final String expectedEncryptedAccess,
      final String expectedEncryptedRefresh,
      final String expectedEncryptedSecret) {
