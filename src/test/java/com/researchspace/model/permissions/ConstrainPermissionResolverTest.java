...
public class ConstrainPermissionResolverTest {
  ...
  private static final String TEST_STRING1 =
      "Record:Read:id=1,2,3&property_owner=user&location=/a/b/c*";
  private static final String TEST_STRING3 =
      "Record:Read,Write,Export:date_range=15-&id=1&property_owner=user&property_name=fred";
  ...
  static final String[] TESTSTRINGS =
      new String[] {TEST_STRING1, TEST_STRING2, TEST_STRING3, TEST_STRING4, TEST_STRING5};
  ...
  public void testStringRoundTrip() {
    for (String toTest : TESTSTRINGS) {
      ...
      PermissionTestUtils.assertPermissionsAreEquivalent(
          p, resolver.resolvePermission(p.getString()));
    }
  }
