...
**Backend:**
- Java 17 source level and Java 17 JDK runtime (Adoptium Temurin, or the JetBrains Runtime in the Docker dev stack); Java 17 language features are allowed
...
1. **Java language level:** Source and runtime are both Java 17 (`<release>17</release>` in `pom.xml`); Java 17 language features (records, sealed classes, text blocks, pattern matching) are allowed.
