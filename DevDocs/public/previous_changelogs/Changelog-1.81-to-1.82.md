RSpace Installation and update changelog 1.82
=============================================

This document describes configuration changes that should be made before updating RSpace server to 1.82.

**Note** 

To update directly to 1.82, you must be running RSpace 1.73 or later.
...
Please note that you **must** update to version 1.73.x (e.g. 1.73.3) before updating to 1.82.

There is a risk of data loss in the database if you update to 1.82 directly from a 1.72.x version or earlier.
