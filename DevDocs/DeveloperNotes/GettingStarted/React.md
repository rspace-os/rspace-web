...
2. Install the Biome plugin `biomejs.biome`. VSCode will now automatically
...
In VSCode JavaScript and TypeScript are tightly coupled. VSCode intellisense and other IDE
